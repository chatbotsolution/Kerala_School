<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Exam.master" AutoEventWireup="true" CodeFile="GradeSubjectMst.aspx.cs" Inherits="Exam_GradeSubjectMst" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <fieldset style="width: 90%">
                <legend><b>Add New Grade Subject</b></legend>
                <table width="100%">
                    ...
                    <tr>
                        <td align="left" valign="baseline">
                            Grade Subject<font color="red">*</font>
                        </td>
                        <td align="left" valign="baseline">
            ...
            <br />
            <fieldset style="width: 90%">
                <legend><b>Grade Subject List</b></legend>
                <table width="100%">
                    <tr>
                        <td align="left" valign="baseline">
