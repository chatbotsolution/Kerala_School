...
public partial class Exam_RptExamReport : System.Web.UI.Page
{
    ...
    private void GenerateReport()
    {
        ...
        try
        {
            ...
            string str3 = obj.ExecuteScalarQry("SELECT Section FROM dbo.PS_ClasswiseStudent WHERE admnno=" + drpStud.SelectedValue + " AND ClassId=" + drpClass.SelectedValue);
            ...
            stringBuilder.Append("<td style='text-align:center;font-size:14px;' colspan='5'>");
            stringBuilder.Append("<b>Exam Progress Report</b></td>");
            stringBuilder.Append("</tr>");
            stringBuilder.Append("<tr>");
            stringBuilder.Append("<td style='text-align:left;font-size:12px;'>Student Name&nbsp;:&nbsp;");
            ...
            stringBuilder.Append("<b>" + drpStud.SelectedValue + "</b></td>");
            ...
            stringBuilder.Append("<td style='text-align:left;font-size:12px;'>Section&nbsp;:&nbsp;<b>" + str3 + "</b></td>");
            stringBuilder.Append("<td style='text-align:left;font-size:12px;'>Session&nbsp;:&nbsp;<b>" + drpSession.SelectedValue + "</b></td>");
            stringBuilder.Append("</tr>");
            stringBuilder.Append("</table>");
            stringBuilder.Append("<table width='100%' border='1' cellspacing='2' cellpadding='2' style='border-collapse:collapse;'>");
            stringBuilder.Append("<tr>");
            stringBuilder.Append("<td style='text-align:center;font-size:12px;' rowspan='2'><b>No</b></td>");
            ...
            if (dataRowArray6.Length > 0)
                stringBuilder.Append("<td style='text-align:center;font-size:12px;' colspan='2'><b>Annual Exam</b></td>");
            ...
            stringBuilder.Append("<tr>");
            stringBuilder.Append("<td style='text-align:left;font-size:12px;' colspan='2'><b>Total Marks</b></td>");
            if (dataRowArray1.Length > 0)
            {
            ...
            stringBuilder.Append("<tr>");
            stringBuilder.Append("<td style='text-align:left;font-size:12px;' width='40%'>");
            stringBuilder.Append("<b>Remarks :-</b><br/><br/><br/><br/></td>");
            stringBuilder.Append("<td style='text-align:center;font-size:12px;'>");
            stringBuilder.Append("<br/><br/><br/><br/><b>Class Teacher</b></td>");
            stringBuilder.Append("<td style='text-align:center;font-size:12px;'>");
            stringBuilder.Append("<br/><br/><br/><br/><b>Exam Controller</b></td>");
            stringBuilder.Append("<td style='text-align:center;font-size:12px;'>");
            stringBuilder.Append("<br/><br/><br/><br/><b>Pradhan Acharya</b></td>");
            stringBuilder.Append("<td style='text-align:center;font-size:12px;'>");
            stringBuilder.Append("<br/><br/><br/><br/><b>Guardian's Signature</b></td>");
            stringBuilder.Append("</tr>");
            stringBuilder.Append("</table>");
