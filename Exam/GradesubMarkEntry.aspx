<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Exam.master" AutoEventWireup="true" CodeFile="GradesubMarkEntry.aspx.cs" Inherits="Exam_GradesubMarkEntry" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">

    <script type="text/javascript">
        function checkObtMarks(objObtMarks) {
            var tObtMarks = document.getElementById(objObtMarks);
            if (tObtMarks.value == null || tObtMarks.value == "") {
                document.getElementById(objObtMarks).value = "";
                alert("Grade shouldn't be Empty");
        ...
        function disable() {
                   document.getElementById("txtgrade").Enabled = false;
        }
        function cnfSubmit() {
                                ...
                                <div>
                                    <table width="100%">
                                        <tr style="background-color: #D3E7EE;">
                                            <td align="left" style="padding: 5px; font-weight: bold; height: 3px; font-family: Tahoma, Geneva, sans-serif; color: #000; border: 1px solid #333; background-color: Transparent;">Session&nbsp;:&nbsp;
                                        ...
                                        <tr style="background-color: #D3E7EE;">
                                            <td align="left" style="padding: 5px; font-weight: bold; height: 3px; font-family: Tahoma, Geneva, sans-serif; color: #000; border: 1px solid #333; background-color: Transparent;">Student Name&nbsp;:&nbsp;
                                        ...
                                        <tr>
                                            <td align="left" valign="top">
                                                <asp:GridView ID="grdStudentwise" runat="server" AutoGenerateColumns="False" Width="50%"
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="Subject">
                                                            ...
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:HiddenField ID="hfExamSubId" runat="server" Value='<%#Eval("SubjectId")%>' />
                                                                <asp:HiddenField ID="hfadmnno" runat="server" Value='<%#Eval("admnno")%>' />
                                                                <asp:HiddenField ID="hfGradeMrkId" runat="server" Value='<%#Eval("GradeMarkId")%>' />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                ...
                                                <asp:GridView ID="grdSubjectwise" runat="server" AutoGenerateColumns="False" Width="50%"
                                                    ...
                                                    <Columns>
                                                          <asp:TemplateField HeaderText="Admission No">
                                                            ...
                                                            <ItemStyle HorizontalAlign="Left" />
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblAdmnNo" Visible="false" runat="server" Text='<%#Eval("AdmnNo")%>'></asp:Label>
                                                                <asp:Label ID="lblOldAdmnNo" runat="server" Text='<%#Eval("OldAdmnNo")%>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField HeaderText="Subject Name">
                                                            ...
                                                            <ItemStyle HorizontalAlign="Left" />
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblSubjectName" runat="server" Visible="false" Text='<%#Eval("SubjectName")%>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
