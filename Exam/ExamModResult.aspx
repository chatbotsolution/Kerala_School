<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Exam.master" AutoEventWireup="true" CodeFile="ExamModResult.aspx.cs" Inherits="Exam_ExamModResult" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">

    <script type="text/javascript">
        function checkObtMarks(tPrevMarks, tFullMarks, objObtMarks) {
            var tObtMarks = document.getElementById(objObtMarks);
            if (parseFloat(tObtMarks.value) > parseFloat(tFullMarks)) {
                document.getElementById(objObtMarks).value = tPrevMarks;
                alert("Secured Marks shouldn't be greater than Full Marks");
                return false;
            }
        }
        function cnfModify() {

            if (confirm("You are going to Modify Result. Previous Marks will be replaced with the New Marks. Do you want to continue ?")) {
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                    ...
                                    <table width="100%">
                                        <tr style="background-color: #D3E7EE;">
                                            <td align="left" style="padding: 5px; font-weight: bold; height: 3px; font-family: Tahoma, Geneva, sans-serif;
                                                ...
                                                Section&nbsp;:&nbsp;
                                                <asp:DropDownList ID="drpSection" runat="server" AutoPostBack="true" TabIndex="3"
                                                    OnSelectedIndexChanged="drpSection_SelectedIndexChanged">
                                                </asp:DropDownList>
                                                Exam&nbsp;:&nbsp;
                                                <asp:DropDownList ID="drpExam" runat="server" AutoPostBack="True" TabIndex="4" OnSelectedIndexChanged="drpExam_SelectedIndexChanged">
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                        <tr style="background-color: #D3E7EE;">
                                            <td align="left" style="padding: 5px; font-weight: bold; height: 3px; font-family: Tahoma, Geneva, sans-serif;
                                                ...
                                                <%--<asp:Button ID="btnSearch" runat="server" OnClick="btnSearch_Click" OnClientClick="return isValid();"
                                                    Text="Search" />--%><asp:Label ID="lblTotStud" runat="server"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="left" valign="top">
                                                <asp:GridView ID="grdMarks" runat="server" AutoGenerateColumns="False" Width="100%"
                                                    BorderStyle="Solid" BorderWidth="0.5px" OnRowDataBound="grdMarks_RowDataBound">
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="Subject">
                                                            ...
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:HiddenField ID="hfIsPresent" runat="server" Value='<%#Eval("IsPresent")%>' />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField HeaderText="Theory Marks">
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtTheory" runat="server" onkeypress="return blockNonNumbers(this, event, true, false)"
                                                                    ...
                                                                    Text='<%#Eval("ObtThMarks")%>' TabIndex="5" Width="50px"></asp:TextBox>
                                                                <b>&nbsp;/&nbsp;<asp:Label ID="lblTheory" runat="server" Text='<%#Eval("MaxThMarks")%>'></asp:Label></b>
                                                                <asp:HiddenField ID="hfObtThMarks" runat="server" Value='<%#Eval("ObtThMarks")%>' />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="PT-1">
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtProject" runat="server" onkeypress="return blockNonNumbers(this, event, true, false)"
                                                                    onblur="if (this.value == '') {this.value = '0';}" onfocus="if(this.value == '0') {this.value = '';}"
                                                                    Text='<%#Eval("ObtProjMarks")%>' TabIndex="5" Width="50px"></asp:TextBox>
                                                                <b>&nbsp;/&nbsp;<asp:Label ID="lblProject" runat="server" Text='<%#Eval("MaxProjMarks")%>'></asp:Label></b>
                                                                <asp:HiddenField ID="hfObtProjMarks" runat="server" Value='<%#Eval("ObtProjMarks")%>' />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="SE">
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtPract" runat="server" onkeypress="return blockNonNumbers(this, event, true, false)"
                                                                    onblur="if (this.value == '') {this.value = '0';}" onfocus="if(this.value == '0') {this.value = '';}"
                                                                    Text='<%#Eval("ObtPractMarks")%>' TabIndex="5" Width="50px"></asp:TextBox>
                                                                <b>&nbsp;/&nbsp;<asp:Label ID="lblPract" runat="server" Text='<%#Eval("MaxPractMarks")%>'></asp:Label></b>
                                                                <asp:HiddenField ID="hfObtPractMarks" runat="server" Value='<%#Eval("ObtPractMarks")%>' />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField HeaderText="Project Name">
                                                            ...
                                                            <HeaderStyle HorizontalAlign="Left" />
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtProjName" runat="server" TabIndex="5" Width="200px" Text='<%#Eval("SubmittedProj")%>'></asp:TextBox>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField HeaderText="Save">
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:Button ID="btnSubmit" runat="server" Text="Save" OnClick="btnSubmit_Click" TabIndex="5"
                                                                    onfocus="active(this);" onblur="inactive(this);" OnClientClick="return cnfModify();" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
                                                </asp:GridView>
        ...
        <Triggers>
            ...
            <asp:PostBackTrigger ControlID="grdMarks" />
        </Triggers>
    </asp:UpdatePanel>
</asp:Content>
