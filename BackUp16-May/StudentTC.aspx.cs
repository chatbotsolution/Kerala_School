...
public partial class Admissions_StudentTC : System.Web.UI.Page
{
    ...
    private void StudSrch()
    {
        ...
        DataTable dataTableQry = obj.GetDataTableQry("select SessionYear,ClassID,Section from PS_ClasswiseStudent cs inner join PS_StudMaster sm on sm.AdmnNo=cs.AdmnNo where sm.OldAdmnNo='" + admno + "' and Statusid in (2,3) ");
    ...
    private void PrintForm()
    {
        ...
        stringBuilder.Append("<tr align='left'><td style='font-size:20px;'> Book No:___________<b></b></td>");
        stringBuilder.Append("<td align='center' style='font-size:20px;'> Sl. No:_____________<b></b></td>");
        stringBuilder.Append("<td align='right' style='font-size:20px;'> Admission No: <i><span class='UlSpan'>" + txtAdmno.Text.Trim() + "</span></i><b></b></td></tr>");
        //stringBuilder.Append("<tr><td align='left' style='width:250px;font-size:20px;'>Admission No :  <i><span class='UlSpan'>" + txtAdmno.Text.Trim() + "</span></i><b></b></td>");
        //stringBuilder.Append("<td align='right' style='width:250px;font-size:20px;'>Sl/TC/SLC No:<b></b></td></tr>");
        stringBuilder.Append("<tr><td colspan='4' align='center' style='font-size:20px;font-weight:bold;' ><u></u></td></tr>");
        stringBuilder.Append("<tr><td colspan='4' align='center'></td></tr>");
        stringBuilder.Append("<tr><td colspan='4' align='center'></td></tr>");
        stringBuilder.Append("<tr><td colspan='4' align='center'></td></tr>");

        stringBuilder.Append("<tr><td colspan='4' style='font-size:20px;'>1. Name Of The Pupil : <i><span class='UlSpan'>" + txtStudName.Text.Trim() + "</span></i></td></tr>");
        stringBuilder.Append("<tr><td colspan='4' style='font-size:20px;'>2. Mother's Name : <i><span class='UlSpan'>" + txtMotherNm.Text.Trim() + "</span></i></td></tr>");
        stringBuilder.Append("<tr><td colspan='4' style='font-size:20px;'>3. Father's Name/Guardian Name : <i><span class='UlSpan'>" + txtFAtherNm.Text.Trim() + "</span></i></td></tr>");
        ...
        stringBuilder.Append("<tr><td colspan='4' style='font-size:20px;'>4. Date of Birth(in Christian Era) according to Addmission & Withdrawal Register: <br>&nbsp;&nbsp;&nbsp;In figures <i><span class='UlSpan'>" + txtDOB.Text.Trim() + "</span></i></td></tr>");
        stringBuilder.Append("<tr><td colspan='4' style='padding-left:16px;font-size:20px;'>In Words : <i><span class='UlSpan'>" + Admissions_StudentTC.NumberToDay(dtpDOB.GetDateValue().Day) + " " + dtpDOB.GetDateValue().ToString("MMMM") + " " + Admissions_StudentTC.NumberToWords(dtpDOB.GetDateValue().Year) + "</span></i></td></tr>");
        stringBuilder.Append("<tr><td colspan='4' style='font-size:20px;'>5. Nationality : <i><span class='UlSpan'>" + hifStudNationality.Value.ToString() + "</span></i></td></tr>");
        stringBuilder.Append("<tr><td colspan='4' style='font-size:20px;'>6 Weather the Candidate belongs to Schedule Cast or Schedule Tribe or OBC : <i><span class='UlSpan'>" + hifStudCat.Value.ToString() + "</span></i></td></tr>");
        stringBuilder.Append("<tr><td colspan='4' style='font-size:20px;'>7. Date Of First Admission in school in With Class: <i><span class='UlSpan'>" + txtAdmnDt.Text.Trim() + "</span></i> , <i><span class='UlSpan'>" + hifStudfstClass.Value.ToString() + "</span></i></td></tr>");
        //stringBuilder.Append("<tr><td colspan='2' style='font-size:20px;'> &nbsp;&nbsp;&nbsp;&nbsp;Class Of First Admission: <i><span class='UlSpan'>" + hifStudfstClass.Value.ToString() + "</span></i></td></tr>");
        ...
        stringBuilder.Append("<tr><td colspan='4' style='font-size:20px;'>8. Class in which the Pupil last studied : (in figures) <i><span class='UlSpan'>" + txtCurrCls.Text.Trim() + "</span></i></td></tr>");
        stringBuilder.Append("<tr><td colspan='4' style='font-size:20px;'> (in Words) <i><span class='UlSpan'>__________________________</span></i></td></tr>");
        stringBuilder.Append("<tr><td colspan='4' style='font-size:20px;'>9. School/Board Anual Examination last taken with result : _____________________ </td></tr>");
        stringBuilder.Append("<tr><td colspan='4' style='font-size:20px;'>10. Whether failed, if so once/twice in the same class : ______________________</td></tr>");
        stringBuilder.Append("<tr><td colspan='4' style='font-size:20px;'>11. Subjects Studied:1._____________,2._____________, 3._____________,4._____________,5._____________,6._____________ </td></tr>");
        stringBuilder.Append("<tr><td colspan='4' style='font-size:20px;'>12. Whether qualified for promotion to higher class if so,to which class : (in figures) <i><span class='UlSpan'>" + txtPromot.Text.Trim() + "</span></i> </br>(in Words) <i><span class='UlSpan'>____________________</span></i></td></tr>");
        ...
        stringBuilder.Append("<tr><td colspan='4' style='font-size:20px;'>13. Month upto which the pupil has paid school dues : <i><span class='UlSpan'></span></i></td></tr>");
        stringBuilder.Append("<tr><td colspan='4' style='font-size:20px;'>14. Any fee concession availed of : if so ,the nature of such concession : __________________<i><span class='UlSpan'></span></i></td></tr>");
        //stringBuilder.Append("<tr><td colspan='2' style='font-size:20px;'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; If Leaving During Mid-Session : <i><span class='UlSpan'>" + txtTcDt.Text.Trim() + "</span></i></td></tr>");
        stringBuilder.Append("<tr><td colspan='4' style='font-size:20px;'>15. Total no. of working days in the academic session : <i><span class='UlSpan'>" + txtWorking.Text.Trim() + "</span></i> <br> 16.&nbsp;Total no. of working days present in the school : <i><span class='UlSpan'>" + txtPresent.Text.Trim() + "</span></i></td></tr>");
        stringBuilder.Append("<tr><td colspan='4' style='font-size:20px;'>17. Whether NCC Cadet/Boy Scout/Girl Guide(details may be given) : ____________________<i><span class='UlSpan'></span></i></td></tr>");
        stringBuilder.Append("<tr><td colspan='4' style='font-size:20px;'>18. Games played or extra-corricular activities in which the pupil usually took part(Mention achievement level there in) : __________________________<i><span class='UlSpan'></span></i></td></tr>");
        stringBuilder.Append("<tr><td colspan='4' style='font-size:20px;'>19. General Conduct : <i><span class='UlSpan'>" + txtCharactr.Text.Trim() + "</span></i></td></tr>");
        stringBuilder.Append("<tr><td colspan='4' style='font-size:20px;'>20. Date of Application for Certificate : ____________<i><span class='UlSpan'></span></i></td></tr>");
        stringBuilder.Append("<tr><td colspan='4' style='font-size:20px;'>21. Date of Issue of Certificate : ________________<i><span class='UlSpan'></span></i></td></tr>");
        stringBuilder.Append("<tr><td colspan='4' style='font-size:20px;'>22. Reasons for leaving the School : ________________<i><span class='UlSpan'></span></i></td></tr>");
        stringBuilder.Append("<tr><td colspan='4' style='font-size:20px;'>23. Any other Remarks : <i><span class='UlSpan'>" + txtRemarks.Text.Trim() + "</span></i></td></tr>");
        ...
        stringBuilder.Append("<tr><td>&nbsp;</td></tr>");
        stringBuilder.Append("<tr><td>&nbsp;</td></tr>");
        stringBuilder.Append("<tr><td>Signature Of:</td><td>Checked By</td><td>Signature Of Principal</td></tr>");
        stringBuilder.Append("<tr><td>Class Teacher</td><td>With Full name & designation</td><td margin-right: 30px;>With Date & School Seal</td></tr>");
        stringBuilder.Append("<tr><td>&nbsp;</td></tr>");
        //stringBuilder.Append("<tr><td>&nbsp;</td></tr>");
        ...
        stringBuilder.Append("<tr align='left'><td style='font-size:20px;'> Book No:<b></b></td>");
        stringBuilder.Append("<td align='center' style='font-size:20px;'> Date :<b></b></td></tr>");
        stringBuilder.Append("<tr><td align='left' style='width:250px;font-size:20px;'>Admission No :  <i><span class='UlSpan'>" + txtAdmno.Text.Trim() + "</span></i><b></b></td>");
        stringBuilder.Append("<td align='center' style='width:250px;font-size:20px;'> Sl/TC/SLC No:<b></b></td></tr>");
        ...
        stringBuilder.Append("<tr><td colspan='2' style='font-size:20px;'>3. Father's Name/Guardian Name : <i><span class='UlSpan'>" + txtFAtherNm.Text.Trim() + "</span></i></td></tr>");
        //stringBuilder.Append("<tr><td colspan='2' style='font-size:20px;'>4. Permanent Address : <i><span class='UlSpan'></span></i></td></tr>");
        //stringBuilder.Append("<tr><td colspan='2' style='font-size:20px;'>&nbsp;&nbsp;&nbsp;Police Station: <i><span class='UlSpan'></span></i> District: <i><span class='UlSpan'></span>Pin: <i><span class='UlSpan'></span></i></td></tr>");
        stringBuilder.Append("<tr><td colspan='2' style='font-size:20px;'>4. DOB(in Christian Era) according to Addmission & Withdrawal Register: <br>&nbsp;&nbsp;&nbsp;In figures <i><span class='UlSpan'>" + txtDOB.Text.Trim() + "</span></i></td></tr>");
        ...
        stringBuilder.Append("<tr><td colspan='2' style='font-size:20px;'>5. Nationality : <i><span class='UlSpan'>" + hifStudNationality.Value.ToString() + "</span></i></td></tr>");
        stringBuilder.Append("<tr><td colspan='2' style='font-size:20px;'>6 Weather the Candidate belongs to SC/ST/OBC : <i><span class='UlSpan'>" + hifStudCat.Value.ToString() + "</span></i></td></tr>");
        stringBuilder.Append("<tr><td colspan='2' style='font-size:20px;'>7. Date Of First Admission in the School With Class : <i><span class='UlSpan'>" + txtAdmnDt.Text.Trim() + "</span></i> , <i><span class='UlSpan'>"+ hifStudNationality.Value.ToString() + "</span></i> +</td></tr>");
        stringBuilder.Append("<tr><td colspan='2' style='font-size:20px;'> Class Of First Admission: <i><span class='UlSpan'>" + hifStudfstClass.Value.ToString() + "</span></i></td></tr>");
        //stringBuilder.Append("<tr><td colspan='2' style='font-size:20px;'>8. Date Of Leaving : <i><span class='UlSpan'>" + txtTcDt.Text.Trim() + "</span></i></td></tr>");
        stringBuilder.Append("<tr><td colspan='2' style='font-size:20px;'>8. Class in which the Pupil last studied : <i><span class='UlSpan'>" + txtCurrCls.Text.Trim() + "</span></i></td></tr>");
        stringBuilder.Append("<tr><td colspan='2' style='font-size:20px;'>9. School/Board Anual Examination last taken with result : _____________________ </td></tr>");
        stringBuilder.Append("<tr><td colspan='2' style='font-size:20px;'>10. Whether failed, if so once/twice in the higher class : ______________________</td></tr>");
        stringBuilder.Append("<tr><td colspan='2' style='font-size:20px;'>11. Subjects Studied:1._____________,2._____________, 3._____________,4._____________,5._____________,6._____________ </td></tr>");
        stringBuilder.Append("<tr><td colspan='2' style='font-size:20px;'>12. Whether Qualified for Promotion to Higher Class if so,to which class : <i><span class='UlSpan'>" + txtPromot.Text.Trim() + "</span></i></td></tr>");
        //stringBuilder.Append("<tr><td colspan='2' style='font-size:20px;'>11. If so, From And To Which Class : <i><span class='UlSpan'>" + txtClass1.Text.Trim() + " , " + txtClass2.Text + "</span></i></td></tr>");
        //stringBuilder.Append("<tr><td colspan='2' style='font-size:20px;'>12. Reason For Leaving The School : <i><span class='UlSpan'></span></i></td></tr>");
        stringBuilder.Append("<tr><td colspan='2' style='font-size:20px;'>13. Month Upto Which Pupil Has Paid School Dues : <i><span class='UlSpan'></span></i></td></tr>");
        stringBuilder.Append("<tr><td colspan='2' style='font-size:20px;'>14. Any fee concession availed of:if so the nature of such concession : __________________<i><span class='UlSpan'></span></i></td></tr>");
        //stringBuilder.Append("<tr><td colspan='2' style='font-size:20px;'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; If Leaving During Mid-Session : <i><span class='UlSpan'>" + txtTcDt.Text.Trim() + "</span></i></td></tr>");
        stringBuilder.Append("<tr><td colspan='2' style='font-size:20px;'>15. Total No Of Working Days in the Academic Section : <i><span class='UlSpan'>" + txtWorking.Text.Trim() + "</span></i> <br> 16.&nbsp;Total No Of Working Days Present in the school : <i><span class='UlSpan'>" + txtPresent.Text.Trim() + "</span></i></td></tr>");
        stringBuilder.Append("<tr><td colspan='2' style='font-size:20px;'>17. Whether NCC Cadot/Boy Scout/Girl Guide(Details may be given) : ____________________<i><span class='UlSpan'></span></i></td></tr>");
        stringBuilder.Append("<tr><td colspan='2' style='font-size:20px;'>18. Games Played or Extra-corricular activities in Which the Pupil usually Tookpart(Mention achievement level there in) : __________________________<i><span class='UlSpan'></span></i></td></tr>");
        stringBuilder.Append("<tr><td colspan='2' style='font-size:20px;'>19. General Conduct : <i><span class='UlSpan'>" + txtCharactr.Text.Trim() + "</span></i></td></tr>");
        stringBuilder.Append("<tr><td colspan='2' style='font-size:20px;'>20. Date of Application for Certificate : ____________<i><span class='UlSpan'></span></i></td></tr>");
        stringBuilder.Append("<tr><td colspan='2' style='font-size:20px;'>21. Date of Issue of Certificate : ________________<i><span class='UlSpan'></span></i></td></tr>");
        stringBuilder.Append("<tr><td colspan='2' style='font-size:20px;'>22. Reasons for Leaving the School : ________________<i><span class='UlSpan'></span></i></td></tr>");
        stringBuilder.Append("<tr><td colspan='2' style='font-size:20px;'>23. Any other Remarks : <i><span class='UlSpan'>" + txtRemarks.Text.Trim() + "</span></i></td></tr>");
        //stringBuilder.Append("<tr><td colspan='2' style='font-size:20px;'>16. All Mark Sheet For the Session Year <i><span class='UlSpan'>" + txtSyr.Text.Trim() + "</span></i> Have Been</td></tr>");
        //stringBuilder.Append("<tr><td colspan='2' style='font-size:20px;'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Attached With This Certificate </td></tr>");

        stringBuilder.Append("<tr><td>&nbsp;</td></tr>");
        stringBuilder.Append("<tr><td>&nbsp;</td></tr>");
        stringBuilder.Append("<tr><td align='Center' >Signature Of:</td><td align='Center' >Checked By</td><td align='Center' style='font-size:18px;'>Signature Of Principal</td></tr>");
        stringBuilder.Append("<tr><td align='Center' >Class Teacher</td><td align='Center' >(With Full Name & designation)</td><td align='Center' style='font-size:18px;'>(With Date and School Seal)</td></tr>");
        stringBuilder.Append("</table>");
        stringBuilder.Append("</fieldset>");
        stringBuilder.Append("</td></tr>");
        stringBuilder.Append("</table>");
    ...
    private string SchoolInformation()
    {
        ...
        if (File.Exists(str1))
        {
            ...
            if (dataSet.Tables.Count > 0)
            {
                ...
                {
                    stringBuilder.Append("<table width='100%' cellpadding='0' cellspacing='0' class='tbltd'><tr><td rowspan='6'> <img src='../images/leftlogo.jpg' width='55px' height='60px'/></td>");
                    ...
                    stringBuilder.Append("<tr><td align='center' style='font-size:20px;'><b><u>TRANSFER CERTIFICATE</u></b></td></tr>");
