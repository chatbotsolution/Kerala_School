...
public partial class Accounts_rptActPaymentVoucherPrint : System.Web.UI.Page
{
    ...
    private void FillData()
    {
        ...
        DataTable dataTable2 = obj.GetDataTable("Acts_GetPaymentVoucher", new Hashtable()
    {
      {
         "@PRId",
    ...
    private void getdata(DataTable dt)
    {
        ...
        stringBuilder.Append("</td></tr>");
        stringBuilder.Append("<tr><td style='font-size: 16px;'>");
        stringBuilder.Append("<font style='font-family:Arial Rounded MT Bold; font-size:18px;'>" + dt.Rows[0]["AcctsHead"].ToString() + "</font>");
        stringBuilder.Append("</td>");
        stringBuilder.Append("<td style='font-size: 16px;' align='right'>");
