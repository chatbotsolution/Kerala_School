<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Accounts.master" AutoEventWireup="true" CodeFile="rptCashLedger.aspx.cs" Inherits="Accounts_rptCashLedger" %>
    ...
    <asp:UpdatePanel runat="server" ID="updadddetail" UpdateMode="Conditional">
        ...
        <ContentTemplate>
            <div align="center">
                ...
                Text="Clear" ></asp:LinkButton>
                                <asp:Button ID="btnView" runat="server" Text="Show Consolidated Report" OnClick="btnView_Click"
                                    OnClientClick="return validate();" TabIndex="3" />
                                <asp:Button ID="btnShowDtls" runat="server" Text="Show Detailed Report" Visible="false"
                                    TabIndex="3" onclick="btnShowDtls_Click" />
