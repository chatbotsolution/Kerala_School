...
public partial class Accounts_OpenFYReInit : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Session["User_Id"] != null)
        {
            ...
            FillAccountCodesDynamically(phControls, "");
            phPrev.Controls.Clear();
            GetNewFYDtls();
            if (Page.IsPostBack)
                return;
            ...
            FillAccountCodesDynamically(phControls, new clsDAL().ExecuteScalarQry("select top(1) FY_Id from dbo.ACTS_FinancialYear order by FY_Id desc"));
            CalculateAmount();
    ...
    private void FillAccountCodesDynamically(PlaceHolder p, string yearId)
    {
        ...
        try
        {
            ...
            foreach (DataRow row4 in (InternalDataCollectionBase)dataTableQry1.Rows)
            {
                ...
                if (p == phControls)
                    ...
                    dropDownList.ID = "txtDebit2_" + num1.ToString().Trim();
                ...
                if (p == phControls)
                    ...
                    hiddenField1.ID = "htAccountDebit2_" + num1.ToString().Trim();
                ...
                if (p == phControls)
                    ...
                    textBox.ID = "txtCredit2_" + num1.ToString().Trim();
                ...
                if (p == phControls)
                    ...
                    hiddenField2.ID = "htAccountCredit2_" + num1.ToString().Trim();
    ...
    private void GetNewFYDtls()
    {
        ...
        hashtable.Add("@FYStartDt", new DateTime(Convert.ToInt32(strArray1[2].ToString().Trim()) - 1, Convert.ToInt32(strArray1[1].ToString().Trim()), Convert.ToInt32(strArray1[0].ToString().Trim())));
        hashtable.Add("@FYEndDt", new DateTime(Convert.ToInt32(strArray2[2].ToString().Trim()) - 1, Convert.ToInt32(strArray2[1].ToString().Trim()), Convert.ToInt32(strArray2[0].ToString().Trim())));
        clsDAL clsDal3 = new clsDAL();
        ...
        hidAccountCount.Value = num1.ToString().Trim();
        phPrev.Controls.Add((Control)htmlTable);
    }
    ...
    protected void btnInitialYear_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            string financialYearId = clsDal1.ExecuteScalarQry("Select top(1) FY_Id from ACTS_FinancialYear order by FY_Id desc");
    ...
    private void InsertData(ArrayList typeList, ArrayList AccountHeadList, ArrayList Amountlist, string financialYearId)
    {
        ...
        if ((!(financialYearId.Trim() == "") ? clsDal.GetDataTable("ACTS_UpdateFinancialYr", hashtable) : clsDal.GetDataTable("ACTS_InsertFinancialYr", hashtable)).Rows.Count > 0)
        {
