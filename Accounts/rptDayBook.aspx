<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Accounts.master" AutoEventWireup="true" CodeFile="rptDayBook.aspx.cs" Inherits="Accounts_rptDayBook" %>
            ...
            <div align="center">
                ...
                Text="Clear" ></asp:LinkButton>
                                ...
                                <asp:Button ID="btnprnt" runat="server" Text="Print" Width="80px" OnClientClick='javascript:PrintContent()'
                                    Visible="False" TabIndex="4" CausesValidation="False" />
                            </td>
                        </tr>
                        <tr>
