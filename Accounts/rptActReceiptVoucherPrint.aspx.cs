...
public partial class Accounts_rptActReceiptVoucherPrint : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Page.IsPostBack || Request.QueryString["PrId"] == null)
            return;
        FillData();
    }
    ...
    private void FillData()
    {
        ...
        DataTable dataTable2 = obj.GetDataTable("Acts_GetReceiptVoucher", new Hashtable()
    {
      {
         "@PRId",
         Request.QueryString["PrId"].ToString()
      }
    });
    ...
    private void getdata(DataTable dt)
    {
        ...
        if (dt.Rows[0]["PmtMode"].ToString().Trim() != "Cash")
            stringBuilder.Append("vide Instrument No : <span style='border-bottom:dotted 1px black;'><b>" + dt.Rows[0]["InstrumentNo"].ToString() + "</b></span>,  Dated : <span style='border-bottom:dotted 1px black;'><b>" + dt.Rows[0]["InstrumentDtStr"].ToString() + "</b></span> , Bank Name : <span style='border-bottom:dotted 1px black;'><b>" + dt.Rows[0]["DrawanOnBank"].ToString() + "</b></span>");
