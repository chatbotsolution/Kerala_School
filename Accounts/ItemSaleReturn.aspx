<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Accounts.master" AutoEventWireup="true" CodeFile="ItemSaleReturn.aspx.cs" Inherits="Accounts_ItemSaleReturn" %>
                        ...
                        <td id="Td2" valign="top" align="left" style="padding-top: 2px;" 
                            ...
                            <table width="99%" cellpadding="0" cellspacing="0" style="border: solid 2px gray; box-shadow: silver 8px 8px 5px; padding: 5px;">
                                ...
                                <tr>
                                    ...
                                    <table>
                                    <tr>
                                    <td>&nbsp;Received From&nbsp;:&nbsp;<asp:TextBox ID="txtRcvdFrom" runat="server" 
                                    ...
                                    onselectedindexchanged="rbtnInvType_SelectedIndexChanged" Visible="False">
                                    ...
                                    <td>
                                        <asp:GridView ID="gvItemsForSale" runat="server" DataKeyNames="ItemCode" 
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="SaleRet Qty.">
                                                    <HeaderStyle HorizontalAlign="Left" Width="50px" />
                                                    <ItemTemplate>
                ...
                textBox.value = " Additional Charges";
                                                ...
                                                <table id="tblPaymentDetails" width="100%" style="border: solid 1px gray;" 
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" class="tbltxt">
                                                            <asp:TextBox ID="txtRcvdAmt" runat="server" CssClass="smalltb" 
                                                                MaxLength="50" TabIndex="18" 
                                                                Width="130px" Visible="False">0</asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left" colspan="3" style="padding-left: 5px; padding-top: 5px;" 
                                                            class="tbltxt">
                                        ...
                                        <tr>
                                            ...
                                            <asp:Button ID="btnSubmitPrint"
                                                        runat="server" Text="Save and Print Bill" Visible="False" 
                                                ...
                                                <asp:Button ID="btncancel" OnClick="btncancel_Click" runat="server"
                                                    ...
                                                    Text="Sale Return List" runat="server" ID="btnSoldList" OnClick="btnSoldList_Click" 
                                                    TabIndex="29" />
                                            </td>
                                        </tr>
                                    </table>
