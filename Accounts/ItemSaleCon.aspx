<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Accounts.master" AutoEventWireup="true" CodeFile="ItemSaleCon.aspx.cs" Inherits="Accounts_ItemSaleCon" %>
                    ...
                    <tr id="Tr2" runat="server">
                        <td id="Td2" valign="top" align="left" style="padding-top: 2px;" 
                            ...
                            <table width="99%" cellpadding="0" cellspacing="0" style="border: solid 2px gray; box-shadow: silver 8px 8px 5px; padding: 5px;">
                                <tr>
                                    <td class="tbltxt" align="left" style="padding-left: 5px; width: 178px;">Received Date&nbsp;:&nbsp;<asp:TextBox 
                                    ...
                                    <td class="tbltxt">
                                        ...
                                        <asp:DropDownList ID="drpclass" runat="server" AutoPostBack="True" 
                                            CssClass="vsmalltb" Width="70px" TabIndex="3" OnSelectedIndexChanged="drpclass_SelectedIndexChanged" >
                                        </asp:DropDownList>
                                    </td>
                                    <td class="tbltxt" style="display:none">
                                        Select Student :
                                    ...
                                    <td class="tbltxt" style=" display:none">
                                        Person Name :
                                        <asp:TextBox ID="txtPersonName" runat="server" CssClass="vsmalltb" Width="180px" 
                                            TabIndex="5"></asp:TextBox>
                                    </td>
                                    <td class="tbltxt">
                                        Set :
                                        <asp:TextBox ID="txtSet" runat="server" CssClass="vsmalltb" Width="30px" 
                                            TabIndex="5"></asp:TextBox>
                                    </td>
                                    <td align="left">
                                        <asp:Button Text="ADD TO LIST" runat="server" ID="btnSearch" 
                            ...
                            <table width="100%">
                                ...
                                <tr>
                                    ...
                                    <asp:Panel ID="pnlAddItem" runat="server" meta:resourcekey="pnlAddItemResource1" 
                                        ...
                                        Set :<span class="mandatory">*</span>
                                        <asp:TextBox ID="txtSetOtherItem" runat="server" CssClass="vsmalltb" Width="30px" 
                                            TabIndex="5"></asp:TextBox>
                                    </td>
                                    ...
                                    <td>
                                        <asp:GridView ID="gvItemsForSale" runat="server" DataKeyNames="ItemCode" 
                                            ...
                                            <Columns>
                                                <asp:TemplateField >
                                                    <ItemTemplate>
                                                        <asp:CheckBox Text="" runat="server" ID="optItem"  OnCheckedChanged="optItem_CheckedChanged" AutoPostBack="true" TabIndex="-1" />
                                                    </ItemTemplate>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" class="tbltxt">
                                                            ...
                                                            Received Amount :<asp:TextBox ID="txtRcvdAmt" runat="server" CssClass="smalltb" 
                                                                MaxLength="50" ontextchanged="txtRcvdAmt_TextChanged" TabIndex="18" 
