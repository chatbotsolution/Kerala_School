...
public partial class Accounts_ItemSaleCon : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            Accounts_ItemSaleCon.edittemp = 0;
            txttotalamt.Text = "";
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        {
            if (drpclass.SelectedIndex > 0)
                drpclass_SelectedIndexChanged(sender, e);
            else
                litHeaderMsg.Text = "*Please Select Class";
        }
        catch (Exception ex)
        {
        }
    ...
    protected void FillBookList()
    {
        ...
        {
            ((TextBox)row.FindControl("txtQty")).Text = txtSet.Text == "" ? "1" : txtSet.Text;
    ...
    protected void PrepBill()
    {
        ...
        if (flag)
        {
            ...
            if (gvItemsForSale.Rows.Count > 0)
            {
                ...
                btnSubmit.Visible = btnSubmitPrint.Visible = true;
            }
        }
        updadd.Update();
    }
        ...
        if (num1 > 0)
        {
            if (flag)
            {
                ...
                if (gvItemsForSale.Rows.Count > 0)
                {
                    ...
                    if (rbtnInvType.SelectedValue == "E")
                    {
                        txttotalamt.Text = Convert.ToString(num6);
                        txtRcvdAmt.Text = Convert.ToString(num6);
                    }
                    else
                    {
                        txttotalamt.Text = txttotalbill.Text;
                        txtRcvdAmt.Text = txttotalbill.Text;
                    }
                    ViewState["SalesDetails"] = dataTable3;
                    btnSubmit.Visible = btnSubmitPrint.Visible = true;
                }
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        foreach (DataRow row in (InternalDataCollectionBase)dataTable1.Rows)
        {
            ...
            {
                flag = true;
                ((TextBox)gvItemsForSale.Rows[index].FindControl("txtQty")).Text = txtSetOtherItem.Text == "" ? "1" : txtSetOtherItem.Text;
            }
            ++index;
        }
        if (!flag)
        {
            ...
            if (dataTable2.Rows.Count > 0)
            {
                ...
                dataTable2.Columns.Add("Discount");
                dataTable2.Columns.Add("TaxAmount", typeof(Decimal));
                dataTable2.Rows[0]["Qty"] = txtSetOtherItem.Text == "" ? "1" : txtSetOtherItem.Text;
