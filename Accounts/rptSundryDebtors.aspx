<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Accounts.master" AutoEventWireup="true" CodeFile="rptSundryDebtors.aspx.cs" Inherits="Accounts_rptSundryDebtors" %>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td align="left" style="height: 14px" colspan="2">
                                <asp:Label ID="lblDebtor" runat="server" Text="Debtors list as on :"></asp:Label>
                                ...
                                <asp:LinkButton ID="lnkbtnDt" runat="server" OnClientClick="javascript:document.forms[0].ctl00_ContentPlaceHolder1_txtstartdate.value='';return false;"
