<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Inner.master" AutoEventWireup="true" CodeFile="BusRouteMasterList.aspx.cs" Inherits="Masters_BusRouteMasterList" %>
                        ...
                        <table width="100%">
                            ...
                            <tr>
                                <td style="width: 100%;" valign="top" colspan="2">
                                    <asp:GridView ID="grvRouteList" runat="server" AutoGenerateColumns="False" Width="100%"
                                        CssClass="mGrid" AlternatingRowStyle-CssClass="alt" DataKeyNames="RouteId" TabIndex="1"
                                        ...
                                        <Columns>
                                            <asp:TemplateField>
                                                ...
                                                <ItemTemplate>
                                                    <input name="Checkb" type="checkbox" value='<%#Eval("RouteId")%>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Route Name">
                                                <ItemTemplate>
                                                    <a href='BusRouteMaster.aspx?rid=<%#Eval("RouteId")%>'>
                                                        <asp:Label ID="RouteName" runat="server" Text='<%#Eval("RouteName")%>'></asp:Label>
                                            ...
                                            <asp:TemplateField HeaderText="Fee">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblFineApplicable" runat="server" Text='<%#Eval("Fee")%>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle Width="50px" HorizontalAlign="Left" VerticalAlign="Middle" />
                                                <HeaderStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Remarks">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblConcessionApplicable" runat="server" Text='<%#Eval("Remarks")%>'></asp:Label>
                                                </ItemTemplate>
