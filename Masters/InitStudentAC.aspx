<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterSetting.master" AutoEventWireup="true" CodeFile="InitStudentAC.aspx.cs" Inherits="Masters_InitStudentAC" %>
                            ...
                            <tr>
                                <td align="left" valign="top" class="tbltxt" style="border: solid 1px Black; width: 100%;"
                                    ...
                                    <asp:Button ID="btnShow" runat="server" OnClick="btnShow_Click" TabIndex="6" OnClientClick="return add();"
                                        Text="Show Students" />&nbsp; <asp:Button ID="btnShowFullSess" 
                                        runat="server"  TabIndex="6" OnClientClick="return add();"
                                        Text="Show (Full Session)" onclick="btnShowFullSess_Click" />&nbsp;<asp:Button ID="btnInitializedAC" runat="server" TabIndex="7"
                                    ...
                                    <asp:GridView ID="grdStudAC" runat="server" AutoGenerateColumns="False" Width="100%"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField  HeaderText="Bus Fee Paid" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="left"
                                                ...
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtBusAmount" runat="Server" Text='<%#Eval("Amount")%>' CssClass="vsmalltb"></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField  HeaderText="Hostel Fee Paid" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="left"
                                                ItemStyle-Width="50px">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtHostAmount" runat="Server" Text='<%#Eval("Amount")%>' CssClass="vsmalltb"></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>
