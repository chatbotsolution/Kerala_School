<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterSetting.master" AutoEventWireup="true" CodeFile="StudentHouse.aspx.cs" Inherits="Masters_StudentHouse" %>
                                            ...
                                            <asp:GridView ID="grdReligion" runat="server" AllowPaging="true" OnRowCommand="grdReligion_RowCommand"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="House">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkReligion" CausesValidation="false" Text='<%#Eval("HouseName")%>'
