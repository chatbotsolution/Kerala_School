<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterSetting.master" AutoEventWireup="true" CodeFile="FeeComponentList.aspx.cs" Inherits="Masters_FeeComponentList" %>
                        ...
                        <table width="100%">
                            <tr>
                                <td style="width: 180px;" valign="top">
                                    ...
                                    <asp:Button ID="btnSetPriority" runat="server" Text="Set Priority Order" OnClick="btnSetPriority_Click"
                                        TabIndex="3" />
                                </td>
                                    ...
                                    <asp:GridView ID="grdFeeComponent" runat="server" AutoGenerateColumns="False" Width="100%"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Fee Name">
                                                <ItemTemplate>
                                                    <a href='FeeComponents.aspx?fid=<%#Eval("FeeID")%>'>
                                            ...
                                            <asp:TemplateField HeaderText="Payment Priority">
                                                <ItemTemplate>
                                                    <asp:HiddenField ID="hfFID" runat="server" Value='<%#Eval("FeeID") %>' />
                                                    <asp:TextBox ID="txtPriority" runat="server" Width="50px" Text='<%#Eval("Priority") %>'></asp:TextBox>
                                                </ItemTemplate>
                                                <ItemStyle Width="75px" HorizontalAlign="Left" VerticalAlign="Middle" />
                                                <HeaderStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                                            </asp:TemplateField>
