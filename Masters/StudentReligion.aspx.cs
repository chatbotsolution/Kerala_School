...
public partial class Masters_StudentReligion : System.Web.UI.Page
{
    ...
    protected void GridFill()
    {
        ...
        grdReligion.DataSource = new Common().GetDataTable("ps_sp_get_StudentReligion", new Hashtable()
    {
      {
         "id",
         0
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (hdnsts.Value != "")
                ht.Add("religionid", hdnsts.Value);
            else
                ht.Add("religionid", 0);
            ht.Add("religion", txtReligion.Text);
            if (Session != null)
                ht.Add("UserID", Convert.ToInt16(Session["User_Id"].ToString()));
            else
                Response.Redirect("../Login.aspx");
            ht.Add("schoolid", Session["SchoolId"].ToString());
            DataTable dataTable = common.GetDataTable("ps_sp_insert_StudentReligion", ht);
            string str = "";
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            foreach (object obj in str1.Split(chArray))
                dataTable = new Common().GetDataTable("ps_sp_get_StudentReligion", new Hashtable()
        {
          {
             "id",
    ...
    protected void grdReligion_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            lblerr.Text = "";
            DataTable dataTable = new Common().GetDataTable("ps_sp_get_StudentReligion", new Hashtable()
      {
        {
           "mode",
           's'
