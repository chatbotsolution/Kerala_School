<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Library.master" AutoEventWireup="true" CodeFile="DepartmentList.aspx.cs" Inherits="Library_DepartmentList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="bedcromb">
        <asp:Label ID="lblTitle" runat="server" Text="Department List"></asp:Label></div>
                            ...
                            <tr>
                                <td colspan="2">
                                    <asp:GridView ID="grdDeptList" runat="server" AutoGenerateColumns="False"
                                        ...
                                        onpageindexchanging="grdDeptList_PageIndexChanging" >
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Action">
                                                <ItemTemplate>
                                                    <a href='DepartmentMaster.aspx?DeptId=<%#Eval("DeptId")%>'>
                                                        Edit
                                                    </a>
                                                </ItemTemplate>
                                                <FooterStyle HorizontalAlign="Left" Width="20px" />
