<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Library.master" AutoEventWireup="true" CodeFile="PublisherList.aspx.cs" Inherits="Library_PublisherList" %>
    ...
    <asp:UpdatePanel ID="uppSubList" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tbltxt">
                ...
                <tr>
                    <td colspan="2">
                        <asp:GridView ID="grdPublisherList" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                            PageSize="15" OnPageIndexChanging="grdPublisherList_PageIndexChanging" CssClass="mGrid"
                            ...
                            <Columns>
                                <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <input type="checkbox" name="Checkb" value='<%# Eval("PublisherId") %>' />
                                    </ItemTemplate>                                    
                                ...
                                <asp:TemplateField HeaderText="Action">
                                    <ItemTemplate>
                                        <a href='PublisherMaster.aspx?PublisherId=<%#Eval("PublisherId")%>'>Edit </a>
                                    </ItemTemplate>                                    
                                    <HeaderStyle HorizontalAlign="Left" Width="20px" />
