<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Library.master" AutoEventWireup="true" CodeFile="CategoryList.aspx.cs" Inherits="Library_CategoryList" %>
                ...
                <tr>
                    <td colspan="2">
                        <asp:GridView ID="grdCatList" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                            PageSize="15" OnPageIndexChanging="grdCatList_PageIndexChanging" CssClass="mGrid"
                            ...
                            <Columns>
                                <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <input type="checkbox" name="Checkb" value='<%# Eval("CatCode") %>' />
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Action">
                                    <ItemTemplate>
                                        <a href='CategoryMaster.aspx?CatCode=<%#Eval("CatCode")%>& title=Edit Category'>Edit</a>
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Left" Width="20px" />
