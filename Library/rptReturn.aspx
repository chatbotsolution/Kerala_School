<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Library.master" AutoEventWireup="true" CodeFile="rptReturn.aspx.cs" Inherits="Library_rptReturn" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function openwindow() {
            var pageurl = "rptReturnPrint.aspx";
        ...
        <ContentTemplate>
            ...
            <div style="width: 100%; text-align: left; border: solid 1px black; margin-top: 5px">
                <table class="tbltxt" cellpadding="2px">
                    <tr>
                        <td>
                            <asp:RadioButtonList ID="rdbtnlstUsertype" runat="server" CssClass="tbltxt" AutoPostBack="true"
