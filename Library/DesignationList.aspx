<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Library.master" AutoEventWireup="true" CodeFile="DesignationList.aspx.cs" Inherits="Library_DesignationList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="bedcromb">
        <asp:Label ID="lblTitle" runat="server" Text="Designation List"></asp:Label></div>
                            ...
                            <tr>
                                <td colspan="2">
                                    <asp:GridView ID="grdDesigList" runat="server" AutoGenerateColumns="False"
                                        AllowPaging="True" PageSize="15" Width="850" 
                                        onpageindexchanging="grdDesigList_PageIndexChanging">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Action">
                                                <ItemTemplate>
                                                    <a href='DesignationMaster.aspx?DesignationId=<%#Eval("DesignationId")%>'>
                                                        Edit
                                                    </a>
                                                </ItemTemplate>
                                                <FooterStyle HorizontalAlign="Left" Width="20px" />
