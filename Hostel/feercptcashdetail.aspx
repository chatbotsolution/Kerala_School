<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Hostel.master" AutoEventWireup="true" CodeFile="feercptcashdetail.aspx.cs" Inherits="Hostel_feercptcashdetail" %>
        ...
        <tr>
            <td style="width: 100%;" valign="middle" class="tbltxt">
                ...
                <asp:TextBox ID="txtadmnno" runat="server" onkeypress="return blockNonNumbers(this, event, false, false);"
                    onkeyup="return checkinteger(this);" TabIndex="5" CssClass="vsmalltb"></asp:TextBox>
            </td>
        </tr>
        <tr>
