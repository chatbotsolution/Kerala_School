<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Hostel.master" AutoEventWireup="true" CodeFile="HostFeeComponents.aspx.cs" Inherits="Hostel_HostFeeComponents" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" UpdateMode="Conditional" runat="server">
        <ContentTemplate>
            <table cellspacing="2" cellpadding="2" width="100%" border="0" class="tbltxt">
                <tbody>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            ...
                            <asp:RequiredFieldValidator ID="rfvfeedesc" runat="server" ControlToValidate="txtfeedesc" ValidationGroup="FeeComp"
                                ErrorMessage="RequiredFieldValidator" Text="Enter Fee Description" SetFocusOnError="true"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td align="left">
...
<%--                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="drpAccountHead"
                                ErrorMessage="RequiredFieldValidator"  Text="Select Expense Account Head" SetFocusOnError="true"></asp:RequiredFieldValidator>
 --%>                       </td>
                    </tr>
                    <tr>
                        <td align="left">
                    ...
                    <tr>
                        ...
                        <td valign="top" align="left">
                            &nbsp;&nbsp;<asp:Button ID="btnSave" OnClick="btnSave_Click" runat="server" Text="Submit" Width="64px"
                                TabIndex="7" ValidationGroup="FeeComp"></asp:Button>
