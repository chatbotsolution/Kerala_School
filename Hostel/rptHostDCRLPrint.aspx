<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptHostDCRLPrint.aspx.cs" Inherits="Hostel_rptHostDCRLPrint" %>
            ...
            <tr>
                <td align="left">
                    <div style="width: 250px; float: left;">
                        <asp:Label ID="Label4" runat="server" Text="Daily Collection Report" Font-Bold="True"></asp:Label></div>
