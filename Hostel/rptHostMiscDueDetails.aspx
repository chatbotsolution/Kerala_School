<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptHostMiscDueDetails.aspx.cs" Inherits="Hostel_rptHostMiscDueDetails" %>
            ...
            <tr>
                <td class="tbltxt">
                    <fieldset id="Fieldset1" runat="server" style="width: 96%">
                        <legend><b>Balance in Miscellaneous Hostel Fees :</b></legend>
