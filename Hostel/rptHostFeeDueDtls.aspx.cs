...
public partial class Hostel_rptHostFeeDueDtls : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Session["SSVMID"] == null || Page.IsPostBack || Request.QueryString["FY"] == null)
            return;
    ...
    private void getdata()
    {
        ...
        DataSet dataSet2 = clsDal.GetDataSet("Host_GetStudFeeDtls", hashtable);
    ...
    private void GetDataFullYr()
    {
        ...
        hashtable.Add("@SchoolID", int.Parse(Session["SchoolId"].ToString()));
        hashtable.Add("@SessionYr", Request.QueryString["sess"].ToString());
        DataSet dataSet2 = clsDal.GetDataSet("Host_GetStudMnthlyFeeDtls", hashtable);
        if (dataSet2.Tables[0].Rows.Count <= 0)
            return;
        lblName.Text = dataSet2.Tables[0].Rows[0]["FullName"].ToString();
        lblRegd.Text = dataSet2.Tables[0].Rows[0]["AdmnNo"].ToString();
