<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Hostel.master" AutoEventWireup="true" CodeFile="ShowHostelStudents.aspx.cs" Inherits="Hostel_ShowHostelStudents" %>
                        ...
                        <table width="100%">
                            <tr>
                                <td align="left" valign="top" class="tbltxt" style="border: solid 1px Black; width: 100%;">
                                    ...
                                    <asp:Button ID="btnImport" runat="server" Text="Import Students" 
                                        onclick="btnImport_Click" Visible="false"/>
                                    <br />
                                    ( Enter some starting text of student name or admission no. and click on show. )
                                </td>
                            ...
                            <tr>
                                <td>
                                    <asp:Button ID="btnNew" runat="server" OnClick="btnNew_Click" Text="Admission" TabIndex="8" />
                                    <asp:Button ID="btnDelete" OnClientClick="return CnfDelete()" Enabled="false" runat="server"
                                        OnClick="btnDelete_Click" Text="Delete Student" TabIndex="9" />
                                </td>
                            </tr>
                            <tr>
                                    ...
                                    <asp:GridView ID="grdstuddet" runat="server" Width="98%" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Name">
                                                <ItemTemplate>
                                                    <a href='HostelAdmission.aspx?sid=<%#Eval("Admissionno")%>&sy=<%# drpSession.SelectedValue %> '>
