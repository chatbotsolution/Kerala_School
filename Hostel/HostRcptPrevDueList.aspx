<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Hostel.master" AutoEventWireup="true" CodeFile="HostRcptPrevDueList.aspx.cs" Inherits="Hostel_HostRcptPrevDueList" %>
    ...
    <table width="100%">
        <tr>
            <td style="width: 100%;" valign="middle" class="tbltxt">
                ...
                From Date :
                <asp:TextBox ID="txtdate" runat="server" CssClass="vsmalltb" TabIndex="3"></asp:TextBox>&nbsp;<rjs:PopCalendar
                    ID="PopCalFmDt" runat="server" Control="txtdate"></rjs:PopCalendar>
                To Date :
                <asp:TextBox ID="txtDateTo" runat="server" CssClass="vsmalltb" TabIndex="4"></asp:TextBox>&nbsp;<rjs:PopCalendar
                ...
                <asp:TextBox ID="txtadmnno" runat="server" onkeypress="return blockNonNumbers(this, event, false, false);"
                    onkeyup="return checkinteger(this);" TabIndex="5"
                    CssClass="vsmalltb"></asp:TextBox>
            </td>
        </tr>
        <tr>
