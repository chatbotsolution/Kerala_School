<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Hostel.master" AutoEventWireup="true" CodeFile="SetHostPrevBal.aspx.cs" Inherits="Hostel_SetHostPrevBal" %>
...
<script language="javascript" type="text/javascript">
    ...
    <div style="padding-top: 5px;">
        <h2>
            Hostel Previous Balance Entry</h2>
    </div>
    <br />
                            ...
                            <tr>
                                <td align="left" valign="top" class="tbltxt" style="border: solid 1px Black; width: 100%;"
                                    ...
                                    <asp:Button ID="btnShow" runat="server" OnClick="btnShow_Click" TabIndex="6" OnClientClick="return add();"
                                        Text="Show Students" />&nbsp;<asp:Button ID="btnSetActHead" runat="server" Visible="false"
