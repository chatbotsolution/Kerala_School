<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Hostel.master" AutoEventWireup="true" CodeFile="InventoryIndividual.aspx.cs" Inherits="Hostel_InventoryIndividual" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function add() {
            ...
            var Loc = document.getElementById("<%=drpIssuedto.ClientID %>").value;
            ...
            if (Loc == 0) {
                ...
                document.getElementById("<%=drpIssuedto.ClientID %>").focus();
                return false;
            }
            else {
                return true;
                ...
                <table width="100%" class="tbltxt">
                    <tr>
                        ...
                        <td style="width: 200px">--%>
                            Issued From 
                            <asp:DropDownList ID="drpIssuedFrom" runat="server" CssClass="tbltxtbox" Width="140px">                                
                                <%--<asp:ListItem Text="--SELECT--" Value="0"></asp:ListItem>--%>
                            </asp:DropDownList>
                        <%--</td>                        
                        <td style="padding-top: 8px; width: 259px;">--%>
                            Issued to :
                            <asp:DropDownList ID="drpIssuedto" runat="server" CssClass="tbltxtbox">
                                <asp:ListItem Text="--SELECT--" Value="0"></asp:ListItem>
                            </asp:DropDownList>
                            <span style="color: Red; font-size: small;">*</span> &nbsp;
                        </td>
