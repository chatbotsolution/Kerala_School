<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptHostelAmountPaidList.aspx.cs" Inherits="Hostel_rptHostelAmountPaidList" %>
...
<head id="Head1" runat="server">
    ...
    <title>Student Hostel Fee Paid Details</title>
</head>
<body>
    ...
    <center>
        <table width="75%" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td class="tbltxt">
                    <fieldset id="Fieldset4" runat="server" style="width: 96%">
