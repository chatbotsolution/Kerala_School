...
public partial class Hostel_HostFeeConcessionRvt : System.Web.UI.Page
{
    ...
    private void fillstudent()
    {
        ...
        DataTable dataTable = obj.GetDataTable("Host_ConsdStudList", new Hashtable()
    {
      {
         "@ClassId",
    ...
    protected void btnDetail_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            DataTable dataTable = obj.GetDataTable("Host_ConsdStudList", hashtable);
            if (dataTable.Rows.Count > 0)
            {
    ...
    private void FillGrid()
    {
        if (drpstudent.SelectedIndex > 0)
        {
            ...
            DataTable dataTable2 = obj.GetDataTable("Host_GetStudConsAmt", hashtable);
    ...
    protected void btnReveret_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            {
                obj = new clsDAL();
                if (obj.ExecuteScalar("Host_RevrtStudConsAmt", new Hashtable()
        {
          {
             "@AdjId",
