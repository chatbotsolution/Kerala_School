...
public partial class Hostel_rptHostelFeeList : System.Web.UI.Page
{
    ...
    private void FillSchoolData()
    {
        ...
        currSession.Split('-');
        DataSet dataSet2 = common.GetDataSet("HostRptGetHostelFee", hashtable);
        ...
        if (dataSet2.Tables[1].Rows.Count > 0)
            ...
            lblSchoolFee.Text = "No Hostel Fee Available !";
