...
public partial class Hostel_rptHostMiscDueDetails : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        getMiscReport(Request.QueryString["admino"].ToString().Trim());
    }

    private void getMiscReport(string studAdmnno)
    {
        ...
        if (Request.QueryString["Fid"].ToString() != "0")
            hashtable.Add("@FeeId", Request.QueryString["Fid"].ToString());
        DataSet dataSet2 = clsDal.GetDataSet("Host_GetMiscFeeDtls", hashtable);
