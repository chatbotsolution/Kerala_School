<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptClasswiseCashReceiptprint.aspx.cs" Inherits="Reports_rptClasswiseCashReceiptprint" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Fee Receipt Cash</title>
<script>
...
<body onload="Print();">
    ...
    <tr>
        <td align="left">
        <asp:Label ID="Label4" runat="server" Text="Fee Receipt Cash" Font-Bold="True" Font-Underline="True"></asp:Label>
        </td>
        <td align="right">
