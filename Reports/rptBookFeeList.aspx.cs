...
public partial class Reports_rptBookFeeList : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
  {
    ...
    if (Request.QueryString["AdId"] != null)
      lblHeader.Text = !(Request.QueryString["AdId"] == "1") ? "Books Fee :" : "Bus Fee :";
  ...
  private void FillMiscData()
  {
    ...
    DataSet dataSet2 = common.GetDataSet("Ps_Sp_GetBookFee", hashtable);
    ...
    {
      MiscFee(dataSet2);
      lblTotal.Text = "<b>Total Amount Due : </b>" + string.Format("{0:f2}",  Convert.ToDouble(dataSet2.Tables[1].Compute("SUM(BooksFee)", "").ToString())).ToString();
    }
    else
      lblMiscFee.Text = "No Book Fee Available !";
  }
  ...
  private void MiscFee(DataSet ds)
  {
    ...
    foreach (DataRow row in (InternalDataCollectionBase) table.Rows)
    {
      ...
      stringBuilder.Append("</td>");
      stringBuilder.Append("<td align='right' class='tbltd'>");
      stringBuilder.Append(row["BooksFee"].ToString().Trim());
      stringBuilder.Append("</td>");
      stringBuilder.Append("</tr>");
    }
