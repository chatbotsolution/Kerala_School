...
public partial class Reports_rptDCRL2 : System.Web.UI.Page
{
    ...
    protected void btnShow_Click(object sender, EventArgs e)
    {
        ...
        {
            DataSet ds = !rbtnBus.Checked ? (!rbtnWoBus.Checked ? common.GetDataSet("ps_sp_get_ALLFeeReceived", hashtable) : common.GetDataSet("ps_sp_get_ALLFeeReceivedWithoutBus", hashtable)) : common.GetDataSet("ps_sp_get_ALLFeeReceivedBus", hashtable);
    ...
    private void GenerateReport(DataSet ds)
    {
        ...
        if (!rbtnBus.Checked && dataTable3.Rows.Count > 0)
        {
            StringBuilder stringBuilder2 = new StringBuilder();
    ...
    protected void rbtnConsol_CheckedChanged(object sender, EventArgs e)
    {
        ...
        if (!rbtnFeeHead.Checked)
            return;
        Response.Redirect("rptDCRMix2.aspx?Dt=" + dtpDate.GetDateValue().ToString("dd MMM yyyy"));
    }
