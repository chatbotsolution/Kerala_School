...
public partial class Reports_rptDCR : System.Web.UI.Page
{
    ...
    protected void btnShow_Click(object sender, EventArgs e)
    {
        ...
        if (drpPmtMode.SelectedIndex > 0)
            hashtable.Add("@CollectionMode", drpPmtMode.SelectedValue.ToString());
       ...
       // DataTable dt = Convert.ToInt32(get_CurrentSessionYr().Trim().Split('-')[0]) < 2014 ? common.GetDataTable("ps_sp_get_FeeReceivedALL", hashtable) : common.GetDataTable("ps_sp_get_FeeReceivedALLNew", hashtable);
        DataTable dt = common.GetDataTable("NewFeecollection",hashtable);
        if (dt.Rows.Count > 0)
        {
            GenerateReport(dt);
    ...
    private void GenerateReport(DataTable dt)
    {
        ...
        stringBuilder.Append("<td style='width: 60px' align='left'>Transaction No</td>");
        stringBuilder.Append("<td style='width: 60px' align='left'>Payment Mode</td>");
        ...
        foreach (DataRow row in (InternalDataCollectionBase)dt.Rows)
        {
            ...
            stringBuilder.Append(row["RecievedDate"].ToString().Trim());
            stringBuilder.Append("</td>");
            stringBuilder.Append("<td align='left'>");
            stringBuilder.Append(row["TrnsNo"].ToString().Trim());
            stringBuilder.Append("</td>");
            stringBuilder.Append("<td align='left'>");
            stringBuilder.Append(row["PaymentMode"].ToString().Trim());
            stringBuilder.Append("</td>");
            stringBuilder.Append("<td align='left'>");
            ...
            stringBuilder.Append("</td>");
            stringBuilder.Append("<td align='left'>");
            stringBuilder.Append(row["FeeDesc"].ToString().Trim());
            stringBuilder.Append("</td>");
    ...
    private void ExportToExcel(string dataToExport)
    {
        try
        {
            string str = Server.MapPath("Exported_Files/DCR" + DateTime.Now.ToString("dd-MM-yyyy hh-mm-ss") + ".xls");
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        try
        {
            ScriptManager.RegisterClientScriptBlock((Page)this, GetType(), "ShowMessage", "window.open('rptDCRPrint.aspx');", true);
        }
        catch (Exception ex)
        {
            string message = ex.Message;
