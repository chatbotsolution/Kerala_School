<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Fee.master" AutoEventWireup="true" CodeFile="rptFeeDetails.aspx.cs" Inherits="Reports_rptFeeDetails" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
<script language="javascript" type="text/javascript">
    function valShow() {
        var Type = document.getElementById("<%=drpStudType.ClientID %>").value;
        ...
        if (Type == "0") {
            ...
            document.getElementById("<%=drpStudType.ClientID %>").focus;
            return false;
        }
        if (Class == "0") {
       ...
       if (Stream == "1"  && (int.parse(Class))>12 ) {
 ...
 <div style="width: 29px; height: 29px; float: left; margin-right: 5px;">
    ...
    <table width="100%" border="0" cellspacing="2" cellpadding="2" class="cnt-box">
        <tr>
            ...
            <td width="120">
                <asp:DropDownList ID="drpStudType" runat="server" CssClass="vsmalltb" Height="16px">
                </asp:DropDownList>
            </td>
             <td width="50" class="tbltxt">
                Class
            ...
            <td width="120">
                <asp:DropDownList ID="drpClass" runat="server" CssClass="vsmalltb" Height="16px" OnSelectedIndexChanged="drpClass_SelectedIndexChanged" AutoPostBack="true">
                </asp:DropDownList>
            </td>
            <td width="50" class="tbltxt">
                Stream
            ...
            <td width="5" class="tbltxt">
             ...
             <td width="120">
                <asp:DropDownList ID="drpStream" runat="server" CssClass="vsmalltb" Height="16px" Enabled="false">
