<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptBookDueDetails.aspx.cs" Inherits="Reports_rptBookDueDetails" %>
...
<body>
    ...
    <center>
        <table width="75%" cellpadding="0" cellspacing="0">
            <tr>
                <td class="tbltxt" style="padding:15px; background-color: #666; color: White;">
                    <div>
            ...
            <tr>
                <td class="tbltxt">
                    <fieldset id="Fieldset1" runat="server" style="width: 96%; background:white;" class="cnt-box2">
                        <legend><b>Balance in Books Fees :</b></legend>
