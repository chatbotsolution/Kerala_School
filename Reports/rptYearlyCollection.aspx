<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Inner.master" AutoEventWireup="true" CodeFile="rptYearlyCollection.aspx.cs" Inherits="Reports_rptYearlyCollection" %>
        ...
        <ContentTemplate>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <td colspan="2">
                        <div>
                            <div style="float:left;width:200px;">
                                <asp:RadioButtonList ID="rdbtnCollectiontype" runat="server" RepeatDirection="Horizontal">
                                    <asp:ListItem Text="Session Year" Value="0" Selected="True"></asp:ListItem>
                                    <asp:ListItem Text="Financial Year" Value="1"></asp:ListItem>
                                </asp:RadioButtonList>&nbsp;
                            </div>
                ...
                <tr>
                    <td colspan="2" style="padding-left:10px;">
                        ...
                        &nbsp;&nbsp;&nbsp;
                        <asp:Button ID="btnShow" runat="server" Text="Show Chart" 
            ...
            <div>
                <asp:Chart ID="Chart1" runat="server" Height="296px" Width="412px" BorderDashStyle="Solid"
                    ...
                    <Titles>
                        <asp:Title Text="Year wise Fee Collection Report " ForeColor="Green">
                        </asp:Title>
                    </Titles>                    
                </asp:Chart>                                                                
            </div>
