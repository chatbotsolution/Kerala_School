<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptAddFeeDueDetails.aspx.cs" Inherits="Reports_rptAddFeeDueDetails" %>
            ...
            <tr>
                <td class="tbltxt">
                    <fieldset id="Fieldset1" runat="server" style="width: 96%; background:white" class="cnt-box2">
                        <legend><b>Balance in
                            <asp:Label ID="lblAdFee" runat="server" CssClass="tbltxt"></asp:Label>
                            Fees :</b></legend>
