...
public partial class Reports_rptQCR : System.Web.UI.Page
{
    ...
    protected void btngo_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            DataSet dataSet2 = obj.GetDataSet("NewQuarterlyFeeCollection", ht);
            if (dataSet2 != null)
            {
                if (dataSet2.Tables[0].Rows.Count > 0)
                {
                    dataSet2.Tables[0].Columns.Add("SecondQtrAmt");
                    dataSet2.Tables[0].Columns.Add("SecondQtrDate");
                    dataSet2.Tables[0].Columns.Add("ThirdQtrAmt");
                    dataSet2.Tables[0].Columns.Add("ThirdQtrDate");
                    dataSet2.Tables[0].Columns.Add("FourthQtrAmt");
                    dataSet2.Tables[0].Columns.Add("FourthQtrDate");
                }
                if (dataSet2.Tables[1].Rows.Count > 0)
                {
                    for (int i = 0; i < dataSet2.Tables[1].Rows.Count; i++)
                    {
                        dataSet2.Tables[0].Rows[i]["SecondQtrAmt"] = dataSet2.Tables[1].Rows[i]["SecondQtrAmt"];
                        dataSet2.Tables[0].Rows[i]["SecondQtrDate"] = dataSet2.Tables[1].Rows[i]["SecondQtrDate"];
                    }
                }
                if (dataSet2.Tables[2].Rows.Count > 0)
                {
                    for (int i = 0; i < dataSet2.Tables[1].Rows.Count; i++)
                    {
                        dataSet2.Tables[0].Rows[i]["ThirdQtrAmt"] = dataSet2.Tables[2].Rows[i]["ThirdQtrAmt"];
                        dataSet2.Tables[0].Rows[i]["ThirdQtrDate"] = dataSet2.Tables[2].Rows[i]["ThirdQtrDate"];
                    }
                }
                if (dataSet2.Tables[3].Rows.Count > 0)
                {
                    for (int i = 0; i < dataSet2.Tables[1].Rows.Count; i++)
                    {
                        dataSet2.Tables[0].Rows[i]["FourthQtrAmt"] = dataSet2.Tables[3].Rows[i]["FourthQtrAmt"];
                        dataSet2.Tables[0].Rows[i]["FourthQtrDate"] = dataSet2.Tables[3].Rows[i]["FourthQtrDate"];
                    }
                }
            ...
            if (dataSet2.Tables[0].Rows.Count > 0 )
            {
                ...
                stringBuilder1.Append("<td rowspan='2' style='font-weight:bold;'>Adm. No</td>");
                stringBuilder1.Append("<td rowspan='2' style='font-weight:bold;'>Name</td>");
                stringBuilder1.Append("<td rowspan='2' style='width:100px; font-weight:bold;'>Class</td>");
                stringBuilder1.Append("<td rowspan='2' style='width:100px; font-weight:bold;'>Section</td>");
                stringBuilder1.Append("<td style='text-align:center; width:300px; font-weight:bold;' colspan='2' >Apr-Jun</td>");
                stringBuilder1.Append("<td style='text-align:center; width:300px; font-weight:bold;' colspan='2' >Jul-Sep</td>");
                stringBuilder1.Append("<td style='text-align:center; width:300px; font-weight:bold;' colspan='2' >Oct-Dec</td>");
                stringBuilder1.Append("<td style='text-align:center; width:300px; font-weight:bold;' colspan='2' >Jan-Mar</td>");
                ...
                for (int index = 0; index < 4; ++index)
                {
                    ...
                    stringBuilder1.Append("<td style='width: 200px; text-align:left; font-weight:bold;' >T.No/Date</td>");
                }
                ...
                {
                    stringBuilder1.Append("<tr><td>"+(k+1).ToString() +"</td>");
                    stringBuilder1.Append("<td>"+ dataSet2.Tables[0].Rows[k]["OldAdmnNo"].ToString()+"</td>");
                    stringBuilder1.Append("<td>"+ dataSet2.Tables[0].Rows[k]["FullName"].ToString()+"</td>");
                    stringBuilder1.Append("<td>"+ dataSet2.Tables[0].Rows[k]["ClassName"].ToString()+"</td>");
                    stringBuilder1.Append("<td>"+ dataSet2.Tables[0].Rows[k]["Section"].ToString()+"</td>");
                    if(Convert.ToDouble (dataSet2.Tables[0].Rows[k]["FirstQtrAmt"].ToString())==0.00)
                        stringBuilder1.Append("<td style='text-align:center'> -- </td>");
                    else
                        stringBuilder1.Append("<td style='text-align:left'>" + Math.Round(Convert.ToDouble(dataSet2.Tables[0].Rows[k]["FirstQtrAmt"].ToString()), 2) + "</td>");
                    stringBuilder1.Append("<td style='text-align:center'>" + dataSet2.Tables[0].Rows[k]["FirstQtrDate"].ToString() + "</td>");

                    if (Convert.ToDouble(dataSet2.Tables[0].Rows[k]["SecondQtrAmt"].ToString()) == 0.00)
                        stringBuilder1.Append("<td style='text-align:center'> -- </td>");
                    else
                        stringBuilder1.Append("<td style='text-align:left'>" + Math.Round(Convert.ToDouble(dataSet2.Tables[0].Rows[k]["SecondQtrAmt"].ToString()), 2) + "</td>");

                    stringBuilder1.Append("<td style='text-align:center'>" + dataSet2.Tables[0].Rows[k]["SecondQtrDate"].ToString() + "</td>");

                    if (Convert.ToDouble(dataSet2.Tables[0].Rows[k]["ThirdQtrAmt"].ToString()) == 0.00)
                        stringBuilder1.Append("<td style='text-align:center'> -- </td>");
                    else
                        stringBuilder1.Append("<td style='text-align:left'>" + Math.Round(Convert.ToDouble(dataSet2.Tables[0].Rows[k]["ThirdQtrAmt"].ToString()), 2) + "</td>");
                    stringBuilder1.Append("<td style='text-align:center'>" + dataSet2.Tables[0].Rows[k]["ThirdQtrDate"].ToString() + "</td>");
                    if (Convert.ToDouble(dataSet2.Tables[0].Rows[k]["FourthQtrAmt"].ToString()) == 0.00)
                        stringBuilder1.Append("<td style='text-align:center'> -- </td>");
                    else
                        stringBuilder1.Append("<td style='text-align:left'>" + Math.Round(Convert.ToDouble(dataSet2.Tables[0].Rows[k]["FourthQtrAmt"].ToString()), 2) + "</td>");

                    stringBuilder1.Append("<td style='text-align:center'>" + dataSet2.Tables[0].Rows[k]["FourthQtrDate"].ToString() + "</td>");

                    num4=Convert.ToDouble(dataSet2.Tables[0].Rows[k]["FirstQtrAmt"].ToString())+ Convert.ToDouble(dataSet2.Tables[0].Rows[k]["SecondQtrAmt"].ToString())+Convert.ToDouble(dataSet2.Tables[0].Rows[k]["ThirdQtrAmt"].ToString())+Convert.ToDouble(dataSet2.Tables[0].Rows[k]["FourthQtrAmt"].ToString());
                     stringBuilder1.Append("<td>"+num4.ToString() +"</td>");
                                Hashtable hashtable2 = new Hashtable();
                                DataTable dataTable3 = new DataTable();
                                hashtable2.Add("@SessionYr", drpSession.SelectedValue.ToString());
                                if (dataSet2.Tables[0].Rows[k]["AdmnNo"].ToString() != "")
                                {
                                    hashtable2.Add("@AdmnNo", dataSet2.Tables[0].Rows[k]["AdmnNo"].ToString().Trim());
                                    dataTable3 = obj.GetDataTable("ps_sp_AnnualMontlyFeeDue", hashtable2);
                                }
                    if(dataTable3 .Rows.Count >0)
                    {
                       
                        num6=Convert.ToDouble(dataTable3.Rows[0]["Due"].ToString());
                        // stringBuilder1.Append("<td>"+ num6.ToString()+"</td>");
                    }
                    else
                    {
                        num6=0.00;
                    }
                    stringBuilder1.Append("<td>" + num6.ToString() + "</td></tr>");
                    num5 = num5 + num4;
                    num7 = num7 + num6;
                }
                ...
                stringBuilder1.Append("<tr>");
                stringBuilder1.Append("<td style='text-align:right; width:100px; font-weight:bold;' colspan='12' >Grand Total</td>");
                stringBuilder1.Append("<td style='text-align:right; font-weight:bold;' colspan='2' >" + num5.ToString() + "</td>");
                stringBuilder1.Append("<td style='text-align:right; font-weight:bold;' colspan='2' >" + num7.ToString() + "</td>");
                stringBuilder1.Append("</tr>");
