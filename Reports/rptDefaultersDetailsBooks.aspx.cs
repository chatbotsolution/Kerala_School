...
public partial class Reports_rptDefaultersDetailsBooks : System.Web.UI.Page
{
    ...
    private void FillDefaultData(string DueDate)
    {
        ...
        DataTable dataTable2 = clsDal.GetDataTable("Ps_Sp_getAdFeeDefaultdetailBooks", hashtable);
