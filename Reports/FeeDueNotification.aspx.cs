...
public partial class Reports_FeeDueNotification : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        fillclass();
        txtWrite.Text = "Dear Parents,\r\rYou are requested to pay the school dues of your ward by " + DateTime.Today.AddMonths(1).ToString("dd MMM yyyy") + " . Ignore if already paid.";
    ...
    private void GenerateReport()
    {
        ...
        dt = obj.GetDataTable("Ps_Sp_DefaultersForNotification2", ht);
        if (dt.Rows.Count > 0)
        {
            lblTotRec.Text = "Total Defaulters:" + dt.Rows.Count.ToString();
            ...
            foreach (DataRow row in (InternalDataCollectionBase)dt.Rows)
            {
                ...
                //stringBuilder.Append("<b>&nbsp;&nbsp;&nbsp;&nbsp;Bus Fee Dues: Rs.&nbsp;</b>");
                //stringBuilder.Append(row["BusFeeDue"].ToString().Trim());
                //stringBuilder.Append("<b>&nbsp;&nbsp;&nbsp;&nbsp;Books Fee Dues: Rs.&nbsp;</b>");
                //stringBuilder.Append(row["BooksFeeDue"].ToString().Trim());
    ...
    //{
    //    Response.Redirect("FeeDueNotificationPrint.aspx");
    //}
