<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptMiscDueDetails.aspx.cs" Inherits="Reports_rptMiscDueDetails" %>
            ...
            <tr>
                <td class="tbltxt">
                    <fieldset id="Fieldset1" runat="server" style="width: 96%; background:white" class="cnt-box2">
                        <legend><b>Balance in Miscellaneous Fees :</b></legend>
