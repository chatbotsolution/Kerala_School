<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptBookFeeList.aspx.cs" Inherits="Reports_rptBookFeeList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <link href="../css/sms.css" rel="stylesheet" type="text/css" />
    <title>Bus & Book Fee</title>
</head>
<body>
        ...
        <table width="75%" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td align="right" style="padding-left: 5px;">
                    <div class="tbltxt lbl2" style="background-color: #666; color: White;">
