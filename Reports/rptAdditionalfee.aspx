<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Inner.master" AutoEventWireup="true" CodeFile="rptAdditionalfee.aspx.cs" Inherits="Reports_rptAdditionalfee" %>
...
<asp:Content ID="contentRemarkReport" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table width="100%" style="height:410px;">
        <TR>
            ...
            <STRONG>Additional Fee Receipt</STRONG> 
            </TD>
        </TR>
        ...
        <table width="100%" >
                ...
                <td colspan="4" align="left" style="height: 56px">
                    ...
                    <asp:TextBox ID="txtFromDate" runat="server" Width="70px" TabIndex="4"></asp:TextBox>&nbsp;<rjs:PopCalendar ID="pcalFromDate" runat="server" Control="txtFromDate" />
                    &nbsp; &nbsp;&nbsp; &nbsp;<asp:Label ID="lblToDate" runat="server" Text="To Date" Font-Bold="False"></asp:Label>
                    <asp:TextBox ID="txtToDate" runat="server" Width="70px" TabIndex="5"></asp:TextBox>
                    <rjs:PopCalendar ID="pcalToDate" runat="server" Control="txtToDate" />
                    &nbsp; &nbsp;&nbsp; &nbsp;<asp:Button ID="btnShow" runat="server" Text="Show" 
                        OnClick="btnShow_Click" TabIndex="6" /><asp:Button ID="btnPrint" 
                        runat="server" Text="Print" OnClick="btnPrint_Click" TabIndex="7" /></td>
            </tr>
            <tr>
        ...
        <asp:Button ID="btnExpExcel" runat="server" OnClick="btnExpExcel_Click" 
                Text="Export to Excel" Visible="False" TabIndex="8" /></td>
        </tr>
        <tr>
        <td ></td>
        </tr>
