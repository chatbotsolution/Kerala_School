<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Inner.master" AutoEventWireup="true" CodeFile="rptNewAdmissionRatioGraph.aspx.cs" Inherits="Reports_rptNewAdmissionRatioGraph" %>
        ...
        <ContentTemplate>
            ...
            <div>
                <asp:Chart ID="Chart1" runat="server" Height="296px" Width="412px" BorderDashStyle="Solid"
                    ...
                    <Titles>
                        <asp:Title Text="New Student Admission Ratio" ForeColor="Green" TextStyle="Emboss" >
                        </asp:Title>
                    </Titles>                    
                </asp:Chart>                
            </div>
