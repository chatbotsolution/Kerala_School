...
public partial class Admissions_StudentTC : System.Web.UI.Page
{
    ...
    {
      {
        ...
        if (dataTable2.Rows.Count > 0)
        {
           ...
           // txtSubStudies.Text = dataTable2.Rows[0]["SubStudies"].ToString();
            txtResLeavingSchool.Text = dataTable2.Rows[0]["ResLeavingScl"].ToString();
    ...
    private void PrintForm()
    {
        ...
        stringBuilder.Append("<tr><td colspan='4' style='font-size:17px;'>6. Date of first admission in the School :<b style='font-family:Times New Roman; font-Size:15px;'><span class='UlSpan'>" + txtAdmnDt.Text.Trim() + "</span></b> , in class : <b style='font-family:Times New Roman'><span class='UlSpan'>" + hifStudfstClass.Value.ToString() + "</span></b></td></tr>");
       ...
       // stringBuilder.Append("<span style='padding-left:16px;'>4</span>.<span style='color: gray;'>...........................</span>,5.<span style='color: gray;'>...........................</span>,6.<span style='color: gray;'>...........................</span> </td>");
        ...
        stringBuilder.Append("</tr>");
        stringBuilder.Append("<tr><td colspan='4' style='font-size:17px;'>19. Reason for leaving the school : <b style='font-family:Times New Roman; font-Size:15px;'> <span style='color: black;'>" + txtResLeavingSchool.Text.Trim() + "</span></b><i><span class='UlSpan'></span></i></td></tr>");
    ...
    private string SchoolInformation()
    {
        ...
        if (File.Exists(str1))
        {
            ...
            if (dataSet.Tables.Count > 0)
            {
                ...
                {
                    stringBuilder.Append("<table width='100%' cellpadding='0' cellspacing='0' class='tbltd'><tr><td rowspan='6'> <img src='../images/leftlogo.jpg' width='120px' height='100px'/></td>");
