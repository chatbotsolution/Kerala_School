<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Inner.master" AutoEventWireup="true" CodeFile="StudentTcNew.aspx.cs" Inherits="Admissions_StudentTcNew" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function Select() {
            ...
            <%--  var  OptnSub1= document.getElementById("<%=drpOptSub1.ClientID %>").value;
              var OptnSub2 = document.getElementById("<%=drpOptSub2.ClientID %>").value;
         --%>
           ...
           <%-- if (OptnSub1.trim() == "") {
                ...
                document.getElementById("<%=drpOptSub1.ClientID %>").focus();
                return false;
            }
            if (OptnSub2.trim() == "") {
                alert("Please Enter  ContactNo");
                document.getElementById("<%=drpOptSub2.ClientID %>").focus();
                return false;
            }--%>
    ...
    <table width="100%" class="cnt-box">
        <tr>
            <td class="tbltxt" colspan="4">Select Session:<asp:DropDownList ID="drpSession" runat="server" AutoPostBack="True"
               ...
               Select Class:<asp:DropDownList ID="drpClass" runat="server" AutoPostBack="True"
                   ...
                   Select Stream:<asp:DropDownList ID="drpStream" runat="server" AutoPostBack="True"
                   CssClass="tbltxtbox" TabIndex="2" OnSelectedIndexChanged="drpStream_SelectedIndexChanged">
               </asp:DropDownList>&nbsp;&nbsp;&nbsp;
    ...
    <asp:Panel runat="server" ID="pnlStud" Visible="false">
        <fieldset class="cnt-box2 tbltxt">
            <table width="100%">
                <tr>
                    <td class="cnt-box tbltxt" colspan="2" align="left" style="width: 100%">Certificate Title:
                ...
                <tr>
                    <td>
                        <table width="100%">
                            ...
                            <tr>
                                <td style="width: 117px">Admission Date&nbsp;:&nbsp;
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtSubStudies" runat="server" Enabled="false" TextMode="MultiLine" Width="170px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>Optional Subject&nbsp;:&nbsp;
                                ...
                                <td>
                                <asp:DropDownList ID="drpOptSub1" runat="server" Visible="false"  width="180px" >
                                    <asp:ListItem Text="Select" Value="Select"/>
                                        <asp:ListItem Text="BIOLOGY" Value="BIOLOGY" />
                                        <asp:ListItem Text="COMPUTER SCIENCE(New)" Value="COMPUTER SCIENCE" />
                                          <asp:ListItem Text="MATHEMATICS" Value="MATHEMATICS" />
                                        <asp:ListItem Text="PHYSICAL EDUCATION" Value="PHYSICAL EDUCATION" />
                                </asp:DropDownList> 
                                </td>
                               </tr>
                                <tr>
                                    <td></td>
                                <td>
                                   <asp:DropDownList ID="drpOptSub2" runat="server" Visible="false"  width="180px">
                                       <asp:ListItem Text="Select" Value="Select" />
                                       <asp:ListItem Text="BIOLOGY" Value="BIOLOGY" />
                                        <asp:ListItem Text="COMPUTER SCIENCE(New)" Value="COMPUTER SCIENCE" />
                                        <asp:ListItem Text="MATHEMATICS" Value="MATHEMATICS" />
                                ...
                                <tr>
                                    <td></td>
                                 <td>
                                   <asp:DropDownList ID="drpOptSub3" runat="server" Visible="false"  width="180px" >
                                       <asp:ListItem Text="Select" Value="Select" />
                                       <asp:ListItem Text="BIOLOGY" Value="BIOLOGY" />
                                        <asp:ListItem Text="COMPUTER SCIENCE(New)" Value="COMPUTER SCIENCE" />
                                        <asp:ListItem Text="MATHEMATICS" Value="MATHEMATICS" />
                            ...
                            <tr>
                                <td>if Extra curricular activities took part (mention Achievement level)&nbsp;:&nbsp;
                                </td>
                                <td>
                ...
                <tr>
                        ...
                        <td>
                            ...
                            <tr>
                                <td>Qualified For Promotion for higher class (in figures)&nbsp;:&nbsp;
                                </td>
                                <td style="width: 140px">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtResLeavingSchool" runat="server" Width="200px" Visible="false" required=""></asp:TextBox>
                                    <asp:DropDownList ID="drpReasonForleave" runat="server" Width="182px">
                                     ...
                                     <asp:RequiredFieldValidator runat="server" id="reqName" controltovalidate="drpReasonForleave" errormessage="Please enter your name!" />
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>Ncc Cadet/Boy Scout/Girl Guide&nbsp;:&nbsp;
                                </td>
                                <td>
                    ...
                    if Extracurricular activitie took part (mention Achivment level)&nbsp;:&nbsp;
                        ...
                        <td >
                            ...
                            <tr>
                                <td>If fee concession availed So, the nature of this&nbsp;:&nbsp;
                                </td>
                                <td style="width: 140px">
                ...
                <asp:Panel ID="PmtPanel" runat="server" Visible="true">
                    <tr>
                        <td colspan="2">Month Upto Which Student Has Paid School Dues
                    ...
                    <tr>
                        ...
                        <td colspan="2" style="padding-top: 20px; border-top: 2px solid #eee">Whether Qualified for Promotion to Higher Class &nbsp
