<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Inner.master" AutoEventWireup="true" CodeFile="rptConductCertificate.aspx.cs" Inherits="Admissions_rptConductCertificate" %>
...
<div style="width: 29px; height: 29px; float: left; margin-right: 5px;">
    ...
    <legend class="tbltxt3">Student Information </legend>
     ...
     <fieldset class="cnt-box4 tbltxt">
    <legend class="tbltxt3" >Conduct Certificate Information </legend>
           ...
           <tr>
            ...
            <tr>
            <td colspan="9" class="tbltxt">
                    <asp:Button ID="btnGenerate" runat="server" Text="Generate Conduct Certificate" 
