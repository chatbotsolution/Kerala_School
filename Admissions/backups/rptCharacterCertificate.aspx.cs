    ...
    private string Information()
    {
        ...
        if (File.Exists(str1))
        {
            ...
            if (dataSet.Tables.Count > 0)
            {
                ...
                {
                    stringBuilder.Append("<table width='100%' cellpadding='2' cellspacing='1' class='tbltd'><tr><td rowspan='5'align='right'> <img src='../images/logo-new.png' width='115px' height='110px'/></td>");
