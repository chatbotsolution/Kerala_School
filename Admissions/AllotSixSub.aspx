<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Inner.master" AutoEventWireup="true" CodeFile="AllotSixSub.aspx.cs" Inherits="Admissions_AllotSixSub" %>
                        ...
                        <table width="100%">
                            <tr>
                                <td align="left" valign="top" class="tbltxt"    colspan="2">
                                    ...
                                    <asp:Button ID="btnUpdtSec" runat="server" OnClick="btnUpdtSixSub_Click" Text="Allot SixthSub" TabIndex="9" />
                                </td>
                                    ...
                                    <asp:GridView ID="grdstudents" Width="100%" runat="server" AutoGenerateColumns="false"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Sixth Subject">
                                                <ItemTemplate>
                                                    <asp:DropDownList ID="drpSixthSub" runat="server" Width="50%">
                                                    </asp:DropDownList>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                                                <HeaderStyle HorizontalAlign="Left" VerticalAlign="Middle" />
