...
public partial class Admissions_Online_Admn_XII : System.Web.UI.Page
{
    ...
    {
        string str = "select * from Nursery_to_Class_X_Master where 1=1 ";

        if (drpSession.Items.Count > 0)
            str = str + " and Official_Admt_session ='" + drpSession.SelectedValue + "'";
        if (drpClass.SelectedValue.ToString().Trim() != "0")
        ...
        if (drpStudStatus.SelectedIndex != 0)
            str = str + " and AdmnFormFee ='" + drpStudStatus.SelectedValue.ToString().Trim() + "'";
        ...
        {
          {
            ...
            Admissions_Online_Admn_XII.ExportToExcelFromDataTable(dataTable2, new int[1], new string[30]
      {
        "AdmnNo",
        "AdmnDate",
        "SessionYear",
    ...
    public static string ExportToExcelFromDataTable(DataTable dtOrig, int[] delColIndx, string[] colNames, string filename)
    {
        try
        {
            if (!Admissions_Online_Admn_XII.validateDelColIndx(dtOrig, delColIndx))
    ...
    private void FillStudStatusDropDown()
    {
        ...
        drpStudStatus.DataSource = new clsDAL().GetDatasetQry("select distinct AdmnFormFee from Nursery_to_Class_X_Master ");
        drpStudStatus.DataTextField = "AdmnFormFee";
        drpStudStatus.DataValueField = "AdmnFormFee";
