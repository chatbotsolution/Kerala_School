<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Inner.master" AutoEventWireup="true" CodeFile="Online_Admission.aspx.cs" Inherits="Admissions_Online_Admission" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="padding-top: 5px;">
        <h2>Online Admission Apply List(NRY-X)</h2>
        <span style="margin-left: 150px;">
            <asp:Label ID="lblMsg" runat="server" Text="Label"></asp:Label></span>
    </div>
        ...
        <ContentTemplate>
            ...
            <table width="100%">
                ...
                <tr>
                    ...
                    <td align="left" valign="top" class="tbltxt cnt-box2 " width="49%">
                        ...
                        <span class="ttl3">
                            <asp:Label ID="lblSession" runat="server" Text="Session :"></asp:Label></span>
                        ...
                        <br />
                        <span class="ttl3">
                            <asp:Label ID="Label2" runat="server" Text="Student Status :"></asp:Label></span>
                        ...
                        <asp:Button ID="btnSave" runat="server" OnClick="btnSave_Click" Enabled="false" Text="Conform" CssClass="btn" />
                    ...
                    <td align="left" valign="top" class="tbltxt cnt-box2" width="49%">
                        ...
                        <div class="spacer"></div>
                        <div>
                            <asp:Label ID="Label1" runat="server" Font-Bold="true" CssClass="tbltxt" ForeColor="Red"></asp:Label>
                        </div>
                    </td>
                </tr>
            </table>
            <table width="100%">
                <tr>
                    ...
                    <td>
                        <label class="tbltxt">TC : </label>
                        <div style="height: 15px; width: 30px; display: inline-block; background-color: Yellow;"></div>
                        &nbsp;&nbsp;</td>
                    <td>
                        <label class="tbltxt">PassOut :</label>
                        <div style="height: 15px; width: 30px; display: inline-block; background-color: Pink"></div>
                        &nbsp;&nbsp;</td>
                    <td>
                        <label class="tbltxt">Absent :</label>
                        <div style="height: 15px; width: 30px; display: inline-block; background-color: Cyan;"></div>
                    </td>
                </tr>
                <tr>
                    <td colspan="4">
                            ...
                            <asp:GridView ID="grdstuddet" runat="server" Width="100%" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    <asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            <input name="Checkb" type="checkbox" value='<%#Eval("Form_No")%>' />
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="From Number">
                                        <ItemTemplate>
                                            <a href='https://kemsadmission.kemschampua.co.in/Admission/Nursery_to_Class_X'>
                                                ...
                                                <asp:HiddenField ID="hfAdNo" runat="server" Value='<%#Eval("Form_No") %>' />
                                        </ItemTemplate>
