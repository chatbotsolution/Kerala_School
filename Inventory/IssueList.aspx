<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Inventory.master" AutoEventWireup="true" CodeFile="IssueList.aspx.cs" Inherits="Inventory_IssueList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <asp:GridView ID="grdItem" runat="server" Width="100%" AutoGenerateColumns="False"
                AllowPaging="true" PageSize="10" DataKeyNames="IssueId" OnPageIndexChanging="grdItem_PageIndexChanging"
                PagerStyle-CssClass="pgr" AlternatingRowStyle-CssClass="alt" CssClass="mGrid"
                TabIndex="4">
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
                            <input name="Checkb" type="checkbox" value='<%#Eval("IssueId")%>' />
                        </ItemTemplate>
                        <HeaderTemplate>
                    ...
                    <asp:TemplateField HeaderText="View Details">
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemTemplate>
                            <a href="javascript:popUp('ViewIssuedDetails.aspx?Id=<%#Eval("IssueId")%>')">
                                View Items</a>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                    </asp:TemplateField>
