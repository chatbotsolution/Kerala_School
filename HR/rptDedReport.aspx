<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/HR.master" AutoEventWireup="true" CodeFile="rptDedReport.aspx.cs" Inherits="HR_rptDedReport" %>
            ...
            <td>
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    ...
                    <strong>Month&nbsp;:&nbsp;
                                                ...
                                                <strong>Select Deduction<font color="red">*</font> :&nbsp;<asp:DropDownList 
                                                    ID="drpDed" runat="server" AutoPostBack="True" Height="19px" 
                                                    style="margin-right: 2px" TabIndex="1" Width="202px">
                                                </asp:DropDownList>
                                                </strong>
                                            </td>
                                        </tr>
