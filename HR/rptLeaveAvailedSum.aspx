<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/HR.master" AutoEventWireup="true" CodeFile="rptLeaveAvailedSum.aspx.cs" Inherits="HR_rptLeaveAvailedSum" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="padding-top: 5px;">
        <h2>
            Employee Leave Availed Report (Summary)</h2>
    </div>
    <div class="spacer">
                ...
                <table width="100%">
                    ...
                    <tr>
                        <td align="left" valign="baseline">
                            <strong>&nbsp;Leave Type&nbsp;:&nbsp;<asp:DropDownList ID="drpLeave" runat="server" AutoPostBack="True"
                                OnSelectedIndexChanged="drpLeave_SelectedIndexChanged" TabIndex="2">
                            </asp:DropDownList>
                            &nbsp;Accounting Year :                             <asp:DropDownList ID="drpAccYear" runat="server" AutoPostBack="True"
                                OnSelectedIndexChanged="drpAccYear_SelectedIndexChanged" TabIndex="2">
                            </asp:DropDownList>
                            &nbsp;&nbsp;<asp:TextBox ID="txtFromDt" runat="server" TabIndex="4" 
