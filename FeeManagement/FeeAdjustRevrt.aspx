<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Fee.master" AutoEventWireup="true" CodeFile="FeeAdjustRevrt.aspx.cs" Inherits="FeeManagement_FeeAdjustRevrt" %>
...
<center>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="1" class="cnt-box">
                    <tr>
                    ...
                    <tr>
                    <td colspan="6">
                        <asp:GridView ID="grdConsession" runat="server" AutoGenerateColumns="false" BorderWidth="1px" BorderColor="#cccccc" CssClass="cnt-box2 tbltxt">
                        <Columns>
                        <asp:TemplateField>
                            <HeaderTemplate>
                            ...
                            <HeaderStyle HorizontalAlign="Center" Width="15px" BackColor="#2092d0" ForeColor="#ffffff" />
                            <ItemTemplate>
                        ...
                        <asp:BoundField DataField="FeeDtls" HeaderText="Fee">
                            ...
                            <HeaderStyle HorizontalAlign="Left" Width="250px" BackColor="#2092d0" ForeColor="#ffffff" />
                        </asp:BoundField>
                        <asp:BoundField DataField="Amnt" HeaderText="Consession Amount">
                            <ItemStyle HorizontalAlign="Left" Width="150px" />
                            <HeaderStyle HorizontalAlign="Left" Width="150px" BackColor="#2092d0" ForeColor="#ffffff"/>
                        </asp:BoundField>
                        </Columns>
                        <EmptyDataTemplate>
