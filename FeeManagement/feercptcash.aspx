                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="2">
                    ...
                    <tr>
                         <td colspan="4" style="width: 100%" valign="baseline">
                            <asp:Label ID="lbloldhostdue" runat="server" Font-Bold="True" ForeColor="Red" CssClass="error"></asp:Label>
                            &nbsp;&nbsp;&nbsp;
                            <asp:Button ID="btnoldhostreciv" runat="server" OnClientClick="return valDetails();"
                                onfocus="active(this);" onblur="inactive(this);" OnClick="btnoldhostreciv_Click"
                                Text="Receive Old Dues" TabIndex="8" />&nbsp;&nbsp;&nbsp;<asp:Label ID="lblhostPrevYrBal"
                  ...
                  <%--       <td class="tbltxt" style="width: 70px" valign="top">
                        ...
                        <td valign="top">
                            <asp:TextBox ID="txtHostelFee" runat="server" CssClass="vsmalltb" meta:resourcekey="txtamtResource1"
                                TabIndex="34" Enabled="true" Width="70px"></asp:TextBox><span class="error">*</span>
                            <asp:Button ID="btnHFClear" runat="server" Text="Clear" CssClass="error"  onfocus="active(this);" onblur="inactive(this);"
                                OnClick="btnHFClear_Click" TabIndex="35" />
                        </td>
                    </tr>
