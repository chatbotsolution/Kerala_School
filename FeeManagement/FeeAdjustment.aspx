<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Fee.master" AutoEventWireup="true" CodeFile="FeeAdjustment.aspx.cs" Inherits="FeeManagement_FeeAdjustment1" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" UpdateMode="Conditional" runat="server">
        <ContentTemplate>
            <table width="100%" border="0" cellpadding="2" cellspacing="2">
                ...
                <tr>
                    <td class="tbltxt">
                        Admn No<span class="error">*</span>
                    </td>
                    <td class="tbltxt">
                        :
                    </td>
                    <td> <asp:TextBox ID="TxtOldAdmnno" runat="server"  
                            TabIndex="4" ></asp:TextBox>
                        
                        <asp:TextBox ID="txtadmnno" runat="server"  
                ...
                <tr>
                    <td class="tbltxt">
                        Discount Date<span class="error">*</span>
                    </td>
                    <td class="tbltxt">
                        :
                    </td>
                    <td>
                        ...
                        <asp:TextBox ID="txtdate" runat="server" meta:resourcekey="txtdateResource1" CssClass=""
                ...
                <tr>
                    <td class="tbltxt" align="left">
                        Discount Type<span class="error">*</span>
                    </td>
                    <td class="tbltxt">
                        :
                    </td>
                    <td class="tbltxt">
                          ...
                          <asp:RadioButton ID="rBtnFeeHeadAmt" runat="server"
                            ...
                            GroupName="contype" CssClass="tbltxt" OnCheckedChanged="rBtnFeeHeadAmt_CheckedChanged"  Checked="true"
                            AutoPostBack="True"  />
                        &nbsp;
                        <asp:RadioButton ID="rBtnMlyAmt" runat="server" Text="Quaterly Fee" ValidationGroup="contype"
                            GroupName="contype" AutoPostBack="True" CssClass="tbltxt" 
                            OnCheckedChanged="rBtnFeeHeadAmt_CheckedChanged"  />&nbsp;
                        <asp:RadioButton ID="rBtnPer" runat="server" Text="Percentage"  ValidationGroup="contype"
                            GroupName="contype" AutoPostBack="True" CssClass="tbltxt" OnCheckedChanged="rBtnFeeHeadAmt_CheckedChanged"  Visible="false" />
                        &nbsp;
                        ...
                        <asp:RadioButton ID="rBtnExtra" runat="server" AutoPostBack="True" 
                            CssClass="tbltxt" GroupName="contype" 
                            OnCheckedChanged="rBtnFeeHeadAmt_CheckedChanged" Text="Extra Curricular Fee" 
                            ValidationGroup="contype"  Visible="false" />
                        ...
                        <table>
                            <tr>
                                ...
                                <td style="height: 23px">
                                    ...
                                    <asp:ListItem>Monthly/Quaterly/Halfyearly Fee</asp:ListItem>
                                    </asp:DropDownList>
