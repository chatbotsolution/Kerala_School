...
public partial class FeeManagement_FeeRecptPrevDueList : System.Web.UI.Page
{
    ...
    private void fillgrid()
    {
        ...
        DataTable dataTable2 = common.GetDataTable("ps_sp_get_FeeRecptPrevBal", hashtable);
    ...
    private void DeleteTrans(string RecptNo)
    {
        ...
        DataTable dataTable = common.GetDataTable("ps_sp_delete_PrevYrfeecash", hashtable);
        new Common().ExecSqlWithHT("ps_sp_insert_FeeLedger_h", new Hashtable()
    {
      {
         "AdmnNo",
        dataTable.Rows[0]["AdmnNo"]
      },
      {
         "VrNo",
        dataTable.Rows[0]["receiptno"]
      }
    });
        updatefeeledger(dataTable, CrAmount);
    }
    ...
    {
        new Common().GetDataTable("ps_sp_update_FeeLedgerPrevYr", new Hashtable()
    {
      {
         "AdmnNo",
    ...
    {
        Response.Redirect("FeeRecptPrevDue.aspx");
    }
